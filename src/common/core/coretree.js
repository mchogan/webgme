...
define(["util/assert", "util/zssha1", "core/future", "core/tasync",
  'util/canon'
], function (ASSERT, ZSSHA1, FUTURE, TASYNC, CANON) {
  "use strict";

  var HASH_REGEXP = new RegExp("#[0-9a-f]{40}");
  var isValidHash = function (key) {
    return typeof key === "string" && key.length === 41 && HASH_REGEXP.test(
      key);
  };
  ...
  return function (storage, options) {
    ...
    var normalize = function (node) {
      ...
      if (node.children === null) {
        ...
        if (node.parent !== null) {
          ...
          ASSERT(node.parent.children === null || __getChildNode(node.parent
            .children, node.relid) === null);
          ...
          if (!isValidHash(temp) || temp !== __getChildData(node.data,
            ID_NAME)) {
            node.data = temp;
          }
        } else {
    ...
    var __areEquivalent = function (data1, data2) {
      return data1 === data2 || (typeof data1 === "string" && data1 ===
        __getChildData(data2, ID_NAME)) || (__isEmptyData(data1) &&
        __isEmptyData(data2));
    };
    ...
    var mutate = function (node) {
      ...
      if (node.parent !== null) {
        ASSERT(__areEquivalent(__getChildData(node.parent.data, node.relid),
          node.data));
    ...
    var __reloadChildrenData = function (node) {
      for (var i = 0; i < node.children.length; ++i) {
        ...
        if (!isValidHash(data) || data !== __getChildData(child.data,
          ID_NAME)) {
          child.data = data;
    ...
    var setProperty = function (node, name, data) {
      ASSERT(typeof name === "string" && name !== ID_NAME);
      ASSERT(!__isMutableData(data) /*&& data !== null*/ && data !==
        undefined); //TODO is the 'null' really can be a value of a property???
    ...
    var getKeys = function (node, predicate) {
      ASSERT(typeof predicate === "undefined" || typeof predicate ===
        "function");
    ...
    var isHashed = function (node) {
      node = normalize(node);
      return typeof node.data === "object" && node.data !== null &&
        typeof node.data[ID_NAME] === "string";
    };
    ...
    var loadChild = function (node, relid) {
      ...
      if (isValidHash(node.data)) {
        ...
        return typeof node.data === "object" && node.data !== null ? node :
          null;
      }
    };
    ...
    var isValidNode = function (node) {
      try {
        ...
        __test("object 2", node.hasOwnProperty("parent") && node.hasOwnProperty(
          "relid"));
        __test("parent", typeof node.parent === "object");
        __test("relid", typeof node.relid === "string" || node.relid ===
          null);
        __test("parent 2", (node.parent === null) === (node.relid ===
          null));
        __test("age", node.age >= 0 && node.age <= MAX_AGE);
        __test("children", node.children === null || node.children instanceof Array);
        __test("children 2", (node.age === MAX_AGE) === (node.children ===
          null));
        __test("data", typeof node.data === "object" || typeof node.data ===
          "string" || typeof node.data === "number");
