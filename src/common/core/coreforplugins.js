...
define(["core/corerel",'core/setcore','core/guidcore','core/nullpointercore','core/coreunwrap', 'core/descriptorcore', 'core/coretype', 'core/constraintcore', 'core/coretree', 'core/metacore', 'core/coretreeloader', 'core/corerootloader'],
    function (CoreRel, Set, Guid, NullPtr, UnWrap, Descriptor, Type, Constraint, CoreTree, Meta, TreeLoader, RootLoader)
    {
        "use strict";
        ...
        function core(storage,options){
            ...
            var corecon = new TreeLoader(new Meta(new Constraint(new Descriptor(new Guid(new Set(new NullPtr(new Type(new NullPtr(new CoreRel(new RootLoader(new CoreTree(storage, options))))))))))));
