...
requirejs(["util/assert", "core/coretree", "storage/mongo", "core/tasync",
  "core/future"
], function (ASSERT, CoreTree, Mongo, TASYNC, FUTURE) {
  "use strict";
  ...
  function test1(coretree) {
    ...
    return TASYNC.call(function () {
      ...
      done = TASYNC.adapt(FUTURE.unadapt(coretree.loadRoot))(coretree.getHash(
        r1));
