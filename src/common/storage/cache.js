  ...
  var Database = function (database, options) {
    ...
    function wrapProject(name, project) {
      ...
      function loadObject(key, callback) {
          ...
          if (typeof obj === "undefined") {
            ...
            if (typeof obj === "undefined") {
              ...
              project.loadObject(key, function (err, obj2) {
                ASSERT(typeof obj2 === "object" || typeof obj2 ===
                  "undefined");
        ...
        ASSERT(typeof obj === "object" && obj !== null && obj[ID_NAME] ===
          key);
        callback(null, obj);
      }

      function insertObject(obj, callback) {
        ASSERT(typeof obj === "object" && obj !== null && typeof callback ===
          "function");
      ...
      function setBranchHash(name, oldhash, newhash, callback) {
        ...
        ASSERT(typeof newhash === "string" && typeof callback ===
          "function");
      ...
      function reopenProject(callback) {
        ASSERT(project !== null && refcount >= 0 && typeof callback ===
          "function");
