...
define(['blob/BlobClient', 'blob/BlobMetadata', 'util/StringStreamWriter'],
  function (BlobClient, BlobMetadata, StringStreamWriter) {
    ...
    BlobRunPluginClient.prototype.getMetadata = function (metadataHash,
      callback) {
      var self = this;
    ...
    BlobRunPluginClient.prototype.getObject = function (metadataHash, callback) {
      ...
      self.blobBackend.getFile(metadataHash, '', writeStream, function (err,
        hash) {
        if (err) {
          callback(err);
          return;
    ...
    BlobRunPluginClient.prototype.putMetadata = function (metadataDescriptor,
      callback) {
      var self = this;
