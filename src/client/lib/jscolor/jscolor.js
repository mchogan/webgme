...
var jscolor = {
  ...
  bind: function () {
    ...
    for (var i = 0; i < e.length; i += 1) {
      var m;
      if (!e[i].color && e[i].className && (m = e[i].className.match(
        matchClass))) {
        var prop = {};
        if (m[3]) {
          try {
  ...
  color: function (target, prop) {
      ...
      if (!isPickerOwner()) {
        ...
        if (!this.pickerSmartPosition) {
          ...
          var pp = [-vp[a] + tp[a] + ps[a] > vs[a] ?
            ...
            (-vp[b] + tp[b] + ts[b] / 2 > vs[b] / 2 && tp[b] + ts[b] - l -
    ...
    this.fromRGB = function (r, g, b, flags) { // null = don't change
      ...
      if (hsv[2] !== 0) {
        this.hsv[1] = hsv[1] === null ? null : Math.max(0.0, this.minS, Math.min(
          1.0, this.maxS, hsv[1]));
      }
      this.hsv[2] = hsv[2] === null ? null : Math.max(0.0, this.minV, Math.min(
        1.0, this.maxV, hsv[2]));
    ...
    function drawPicker(x, y) {
      ...
      p.padM.style.left = '0';
      p.padM.style.top = '0';
      p.padM.style.width = THIS.pickerFace + 2 * THIS.pickerInset + jscolor.images
        .pad[0] + jscolor.images.arrow[0] + 'px';
    ...
    function redrawPad() {
      ...
      jscolor.picker.padM.style.backgroundPosition =
        (THIS.pickerFace + THIS.pickerInset + x - Math.floor(jscolor.images.cross[
        0] / 2)) + 'px ' +
        (THIS.pickerFace + THIS.pickerInset + y - Math.floor(jscolor.images.cross[
        1] / 2)) + 'px';
    ...
    function redrawSld() {
      ...
      jscolor.picker.sldM.style.backgroundPosition =
        '0 ' + (THIS.pickerFace + THIS.pickerInset + y - Math.floor(jscolor.images
          .arrow[1] / 2)) + 'px';
    }
    ...
    function setPad(e) {
      ...
      switch (modeID) {
      case 0:
        THIS.fromHSV(x * (6 / (jscolor.images.pad[0] - 1)), 1 - y / (jscolor.images
          .pad[1] - 1), null, leaveSld);
        break;
      case 1:
