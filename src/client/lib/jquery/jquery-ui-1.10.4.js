      ...
      if (($.ui.ie && (/(static|relative)/).test(this.css("position"))) ||
        ...
        scrollParent = this.parents().filter(function () {
          return (/(relative|absolute|fixed)/).test($.css(this,
            "position")) && (/(auto|scroll)/).test($.css(this,
            "overflow") + $.css(this, "overflow-y") + $.css(this,
            "overflow-x"));
        }).eq(0);
      } else {
        scrollParent = this.parents().filter(function () {
...
(function ($, undefined) {
  ...
  $.widget("ui.draggable", $.ui.mouse, {
    ...
    _mouseStop: function (event) {
      ...
      if (this.options.helper === "original" && !$.contains(this.element[0]
        .ownerDocument, this.element[0])) {
        return false;
      }
    ...
    _setContainment: function () {
      ...
      if (o.containment === "document") {
        this.containment = [
          0,
          0,
          $(document).width() - this.helperProportions.width - this.margins
          .left, ($(document).height() || document.body.parentNode.scrollHeight) -
      ...
      this.containment = [
        (parseInt(c.css("borderLeftWidth"), 10) || 0) + (parseInt(c.css(
          ...
          0) + (parseInt(c.css("paddingTop"), 10) || 0), (over ? Math.max(
          ce.scrollWidth, ce.offsetWidth) : ce.offsetWidth) - (parseInt(c.css(
          "borderRightWidth"), 10) || 0) - (parseInt(c.css("paddingRight"),
          10) || 0) - this.helperProportions.width - this.margins.left -
        this.margins.right, (over ? Math.max(ce.scrollHeight, ce.offsetHeight) :
      ...
      if (this.originalPosition) {
        ...
        if (o.grid) {
          ...
          pageY = containment ? ((top - this.offset.click.top >=
            containment[1] || top - this.offset.click.top > containment[3]
          ...
          pageX = containment ? ((left - this.offset.click.left >=
            containment[0] || left - this.offset.click.left > containment[
              2]) ? left : ((left - this.offset.click.left >= containment[
        ...
        if (this.instance._intersectsWith(this.instance.containerCache)) {
          ...
          $.each(inst.sortables, function () {
            ...
            if (this !== thisSortable &&
              ...
              $.contains(thisSortable.instance.element[0], this.instance
                .element[0])
            ) {
...
(function ($, undefined) {
  ...
  $.widget("ui.droppable", {
    ...
    _drop: function (event, custom) {
      ...
      this.element.find(":data(ui-droppable)").not(".ui-draggable-dragging")
        .each(function () {
    ...
    drop: function (draggable, event) {
      ...
      $.each(($.ui.ddmanager.droppables[draggable.options.scope] || []).slice(),
        function () {
          ...
          if (!this.options.disabled && this.visible && this.accept.call(this
            .element[0], (draggable.currentItem || draggable.element))) {
            this.isout = true;
            this.isover = false;
...
(function ($, undefined) {
  ...
  $.widget("ui.resizable", $.ui.mouse, {
    ...
    _proportionallyResize: function () {
      ...
      for (i = 0; i < this._proportionallyResizeElements.length; i++) {
        ...
        if (!this.borderDif) {
          this.borderDif = [];
          borders = [prel.css("borderTopWidth"), prel.css(
            "borderRightWidth"), prel.css("borderBottomWidth"), prel.css(
            "borderLeftWidth")];
  ...
  $.ui.plugin.add("resizable", "containment", {
    ...
    resize: function (event) {
      ...
      woset = Math.abs((that._helper ? that.offset.left - cop.left : (that.offset
        .left - cop.left)) + that.sizeDiff.width);
      hoset = Math.abs((that._helper ? that.offset.top - cop.top : (that.offset
        .top - co.top)) + that.sizeDiff.height);

      isParent = that.containerElement.get(0) === that.element.parent().get(
        0);
...
(function ($, undefined) {
  ...
  $.widget("ui.sortable", $.ui.mouse, {
    ...
    _create: function () {
      ...
      this.floating = this.items.length ? o.axis === "x" || isFloating(this
        .items[0].item) : false;
      ...
      if (this.options.scroll) {
        if (this.scrollParent[0] !== document && this.scrollParent[0].tagName !==
          ...
          if ((this.overflowOffset.top + this.scrollParent[0].offsetHeight) -
            event.pageY < o.scrollSensitivity) {
            this.scrollParent[0].scrollTop = scrolled = this.scrollParent[0]
    ...
    _mouseStop: function (event, noPropagation) {
      ...
      if (this.options.revert) {
        ...
        if (!axis || axis === "x") {
          animation.left = cur.left - this.offset.parent.left - this.margins
    ...
    _intersectsWithPointer: function (item) {
      ...
      var isOverElementHeight = (this.options.axis === "x") || isOverAxis(
        ...
        isOverElementWidth = (this.options.axis === "y") || isOverAxis(this
          .positionAbs.left + this.offset.click.left, item.left, item.width
        ),
        isOverElement = isOverElementHeight && isOverElementWidth,
    ...
    _intersectsWithSides: function (item) {
      ...
      var isOverBottomHalf = isOverAxis(this.positionAbs.top + this.offset.click
          .top, item.top + (item.height / 2), item.height),
        isOverRightHalf = isOverAxis(this.positionAbs.left + this.offset.click
          .left, item.left + (item.width / 2), item.width),
        verticalDirection = this._getDragVerticalDirection(),
        horizontalDirection = this._getDragHorizontalDirection();
    ...
    _getItemsAsjQuery: function (connected) {
          ...
          for (j = cur.length - 1; j >= 0; j--) {
            ...
            if (inst && inst !== this && !inst.options.disabled) {
              queries.push([$.isFunction(inst.options.items) ? inst.options
                .items.call(inst.element) : $(inst.options.items, inst.element)
      ...
      queries.push([$.isFunction(this.options.items) ? this.options.items.call(
        ...
        ".ui-sortable-helper").not(".ui-sortable-placeholder"), this]);
          ...
          update: function (container, p) {
            ...
            if (!p.width()) {
              p.width(that.currentItem.innerWidth() - parseInt(that.currentItem
                .css("paddingLeft") || 0, 10) - parseInt(that.currentItem
    ...
    _contactContainers: function (event) {
      ...
      if (this.containers.length === 1) {
        ...
        for (j = this.items.length - 1; j >= 0; j--) {
          ...
          if (floating && !isOverAxis(this.positionAbs.top + this.offset.click
            .top, this.items[j].top, this.items[j].height)) {
            continue;
          }
    ...
    _setContainment: function () {
      ...
      if (o.containment === "document" || o.containment === "window") {
        this.containment = [
          ...
          this.helperProportions.width - this.margins.left, ($(o.containment ===
      ...
      if (!(/^(document|window|parent)$/).test(o.containment)) {
        ...
        this.containment = [
          ...
          (parseInt($(ce).css("borderTopWidth"), 10) || 0) - (parseInt($(ce)
      ...
      if (this.originalPosition) { //If we are not dragging yet, we won't check for options
        ...
        if (o.grid) {
          ...
          pageY = this.containment ? ((top - this.offset.click.top >= this.containment[
              1] && top - this.offset.click.top <= this.containment[3]) ?
          ...
          pageX = this.containment ? ((left - this.offset.click.left >=
            this.containment[0] && left - this.offset.click.left <= this.containment[
    ...
    _clear: function (event, noPropagation) {
      ...
      for (i = this.containers.length - 1; i >= 0; i--) {
        if (!noPropagation) {
          delayedTriggers.push(delayEvent("deactivate", this, this.containers[
            i]));
        }
        if (this.containers[i].containerCache.over) {
      ...
      if (this._storedZIndex) {
        this.helper.css("zIndex", this._storedZIndex === "auto" ? "" : this
          ._storedZIndex);
      }
        ...
        if (type === "object") {
          if (red instanceof color) {
            ...
            each(spaces, function (spaceName, space) {
              ...
              if (inst[cache] && jQuery.inArray(null, inst[cache].slice(
                0, 3)) < 0) {
  ...
  $.extend(Datepicker.prototype, {
    ...
    _updateAlternate: function (inst) {
      ...
      if (altField) { // update alternate field too
        ...
        dateStr = this.formatDate(altFormat, date, this._getFormatConfig(
          inst));
    ...
    _generateHTML: function (inst) {
      ...
      if (maxDate) {
        maxDraw = this._daylightSavingAdjust(new Date(maxDate.getFullYear(),
          maxDate.getMonth() - (numMonths[0] * numMonths[1]) + 1, maxDate
          .getDate()));
            ...
            for (dow = 0; dow < 7; dow++) { // create date picker days
              ...
              (otherMonth && !showOtherMonths ? "" : " " + daySettings[1] + // highlight custom dates
                (printDate.getTime() === currentDate.getTime() ? " " + this
                  ._currentClass : "") + // highlight selected day
      ...
      if (!inst.yearshtml) {
        ...
        if (secondary || !changeYear) {
          ...
          determineYear = function (value) {
            var year = (value.match(/c[+\-].*/) ? drawYear + parseInt(value
                .substring(1), 10) :
    ...
    _createWrapper: function () {
      ...
      this._on(this.uiDialog, {
        keydown: function (event) {
          ...
          if ((event.target === last[0] || event.target === this.uiDialog[
            0]) && !event.shiftKey) {
            first.focus(1);
            event.preventDefault();
...
(function ($, undefined) {
  ...
  $.effects.effect.bounce = function (o, done) {
    ...
    if (queuelen > 1) {
      queue.splice.apply(queue, [1, 0].concat(queue.splice(queuelen, anims +
        1)));
    }
    el.dequeue();
