...
(function (window, angular, undefined) {
  ...
  angular.module("gdi2290.moment", ["gdi2290.moment-service",
    "gdi2290.amDateFormat", "gdi2290.amTimeAgo"
  ]);
  "use strict";
  angular.module("gdi2290.amDateFormat").filter("amDateFormat", function (
    $moment) {
  ...
  "use strict";
  angular.module("gdi2290.amTimeAgo").directive("amTimeAgo", function (
    $moment, $timeout) {
