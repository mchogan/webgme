      ...
      function ($rootScope, $location, $routeParams, $q, $injector, $http,
        ...
        function switchRouteMatcher(on, route) {
          ...
          for (var i = 1, len = m.length; i < len; ++i) {
            ...
            var val = 'string' == typeof m[i] ? decodeURIComponent(m[i]) : m[
              i];
        ...
        function updateRoute() {
          ...
          if (next && last && next.$$route === last.$$route && angular.equals(
            ...
            if (next) {
              if (next.redirectTo) {
                if (angular.isString(next.redirectTo)) {
                  $location.path(interpolate(next.redirectTo, next.params)).search(
                    next.params)
                    .replace();
                } else {
            ...
            then(function (locals) {
              ...
              if (next == $route.current) {
                $rootScope.$broadcast('$routeChangeError', next, last,
                  error);
              }
            });
          }
