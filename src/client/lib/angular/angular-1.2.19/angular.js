    ...
    if (obj) {
      if (isFunction(obj)) {
        for (key in obj) {
          ...
          if (key != 'prototype' && key != 'length' && key != 'name' && (!obj
 ...
 */
  ...
  if (msie < 9) {
    nodeName_ = function (element) {
      ...
      return (element.scopeName && element.scopeName != 'HTML') ? uppercase(
 ...
 */
  ...
  function shallowCopy(src, dst) {
    if (isArray(src)) {
      ...
      for (var key in src) {
        if (hasOwnProperty.call(src, key) && !(key.charAt(0) === '$' && key.charAt(
          1) === '$')) {
          dst[key] = src[key];
        }
      }
  ...
  function bind(self, fn) {
    ...
    if (isFunction(fn) && !(fn instanceof RegExp)) {
      return curryArgs.length ? function () {
        return arguments.length ? fn.apply(self, curryArgs.concat(slice.call(
 ...
 */
  ...
  function bootstrap(element, modules) {
    var doBootstrap = function () {
      ...
      if (element.injector()) {
        var tag = (element[0] === document) ? 'document' : startingTag(
          element);
...
*/
  ...
  function jqLiteBuildFragment(html, context) {
    ...
    if (jqLiteIsTextNode(html)) {
      ...
      for (j = 0, jj = tmp.childNodes.length; j < jj; ++j) nodes.push(tmp.childNodes[
        j]);
  ...
  forEach({
    ...
    scope: function (element) {
      ...
      return jqLite(element).data('$scope') || jqLiteInheritedData(element.parentNode ||
    ...
    JQLite.prototype[name] = function (arg1, arg2) {
      ...
      if (fn !== jqLiteEmpty &&
        ...
        if (isObject(arg1)) {
          ...
          var jj = (value === undefined) ? Math.min(nodeCount, 1) :
            nodeCount;
          for (var j = 0; j < jj; j++) {
      ...
      forEach(modulesToLoad, function (module) {
        ...
        try {
          if (isString(module)) {
            ...
            for (invokeQueue = moduleFn._invokeQueue, i = 0, ii =
    ...
    function createInternalInjector(cache, factory) {
      ...
      function invoke(fn, self, locals) {
        ...
        for (i = 0, length = $inject.length; i < length; i++) {
          ...
          args.push(
            locals && locals.hasOwnProperty(key) ? locals[key] : getService(
              key)
          );
        }
        if (isArray(fn)) {
      ...
      return {
        ...
        annotate: annotate,
        has: function (name) {
          return providerCache.hasOwnProperty(name + providerSuffix) || cache
            .hasOwnProperty(name);
        }
      };
    }
      ...
      function ($window, $location, $rootScope) {
        ...
        function getFirstAnchor(list) {
          ...
          forEach(list, function (element) {
            if (!result && lowercase(element.nodeName) === 'a') result =
              element;
          });
          return result;
        }
  ...
  function Browser(window, document, $log, $sniffer) {
    ...
    self.onUrlChange = function (callback) {
      ...
      if (!urlChangeInit) {
        ...
        // hashchange event
        if ($sniffer.hashchange) jqLite(window).on('hashchange',
          fireUrlChange);
        // polling
    ...
    this.$get = [
       ...
       */
        ...
        var startSymbol = $interpolate.startSymbol(),
          ...
          identity : function denormalizeTemplate(template) {
        ...
        function compile($compileNodes, transcludeFn, maxPriority,
          ...
          return function publicLinkFn(scope, cloneConnectFn,
            ...
            if (compositeLinkFn) compositeLinkFn(scope, $linkNode,
              $linkNode, parentBoundTranscludeFn);
            return $linkNode;
          };
        }
              ...
              if (nodeLinkFn) {
                ...
                if (nodeLinkFn.transcludeOnThisElement) {
                  childBoundTranscludeFn = createBoundTranscludeFn(scope,
                    nodeLinkFn.transclude, parentBoundTranscludeFn);
        ...
        function createBoundTranscludeFn(scope, transcludeFn,
          ...
          var boundTranscludeFn = function (transcludedScope, cloneFn,
            controllers) {
        ...
        function collectDirectives(node, directives, attrs, maxPriority,
          ...
          case 1:
            ...
            for (var attr, name, nName, ngAttrName, value, isNgAttr, nAttrs =
              node.attributes,
        ...
        function applyDirectivesToNode(directives, compileNode, templateAttrs,
          ...
          for (var i = 0, ii = directives.length; i < ii; i++) {
            ...
            if (directive.template) {
              ...
              directiveValue = (isFunction(directive.template)) ? directive.template(
                $compileNode, templateAttrs) : directive.template;
            ...
            if (directive.templateUrl) {
              ...
              nodeLinkFn = compileTemplateUrl(directives.splice(i, directives
                  .length - i), $compileNode,
          ...
          function addLinkFns(pre, post, attrStart, attrEnd) {
            if (pre) {
              if (attrStart) pre = groupElementsLinkFnWrapper(pre, attrStart,
                attrEnd);
            ...
            if (post) {
              if (attrStart) post = groupElementsLinkFnWrapper(post,
                attrStart, attrEnd);
          ...
          function getControllers(directiveName, require, $element,
            ...
            if (isString(require)) {
              ...
              value = value || $element[retrievalMethod]('$' + require +
                'Controller');
          ...
          function nodeLinkFn(childLinkFn, scope, linkNode, $rootElement,
            ...
            if (compileNode === linkNode) {
              ...
              attrs = shallowCopy(templateAttrs, new Attributes(jqLite(
                linkNode), templateAttrs.$attr));
            }
            ...
            if (newIsolateScopeDirective) {
              ...
              forEach(newIsolateScopeDirective.scope, function (definition,
                scopeName) {
        ...
        function assertNoDuplicate(what, previousDirective, directive,
          ...
          if (previousDirective) {
            throw $compileMinErr('multidir',
              ...
              previousDirective.name, directive.name, what, startingTag(
                element));
          }
        }
          ...
          if (interpolateFn) {
            directives.push({
              ...
              compile: function textInterpolateCompileFn(templateNode) {
                ...
                if (hasCompileParent) safeAddClass(templateNode.parent(),
                  'ng-binding');
                ...
                return function textInterpolateLinkFn(scope, node) {
                  ...
                  if (!hasCompileParent) safeAddClass(parent,
                    'ng-binding');
        ...
        return function (expression, locals) {
          ...
          if (isString(expression)) {
            ...
            expression = controllers.hasOwnProperty(constructor) ?
              controllers[constructor] : getter(locals.$scope, constructor,
                true) || getter($window, constructor, true);
  ...
  function $HttpProvider() {
    ...
    this.$get = ['$httpBackend', '$browser', '$cacheFactory', '$rootScope',
      ...
      function ($httpBackend, $browser, $cacheFactory, $rootScope, $q,
        ...
        forEach(responseInterceptorFactories, function (interceptorFactory,
          index) {
          var responseFn = isString(interceptorFactory) ? $injector.get(
     ...
     */
        function $http(requestConfig) {
          ...
          function transformResponse(response) {
            ...
            var resp = extend({}, response, {
              data: transformData(response.data, response.headers, config
                .transformResponse)
            });
          ...
          function mergeHeaders(config) {
            ...
            defHeaders = extend({}, defHeaders.common, defHeaders[lowercase(
              config.method)]);
        ...
        function sendReq(config, reqData, reqHeaders) {
          ...
          if ((config.cache || defaults.cache) && config.cache !== false &&
            config.method == 'GET') {
            cache = isObject(config.cache) ? config.cache : isObject(defaults
              .cache) ? defaults.cache : defaultCache;
          }
            ...
            if (isDefined(cachedResp)) {
              if (cachedResp.then) {
                ...
                if (isArray(cachedResp)) {
                  resolvePromise(cachedResp[1], cachedResp[0], shallowCopy(
                    cachedResp[2]), cachedResp[3]);
                } else {
          ...
          if (isUndefined(cachedResp)) {
            var xsrfValue = urlIsSameOrigin(config.url) ? $browser.cookies()[
              config.xsrfCookieName || defaults.xsrfCookieName] : undefined;
            if (xsrfValue) {
  ...
  function $HttpBackendProvider() {
    this.$get = ['$browser', '$window', '$document',
      function ($browser, $window, $document) {
        return createHttpBackend($browser, createXhr, $browser.defer, $window
          .angular.callbacks, $document[0]);
      }
    ];
  }
  ...
  function createHttpBackend($browser, createXhr, $browserDefer, callbacks,
    ...
    return function (method, url, post, callback, headers, timeout,
      ...
      function completeRequest(callback, status, response, headersString,
        ...
        if (status === 0) {
          status = response ? 200 : urlResolve(url).protocol == 'file' ?
            404 : 0;
        }
 ...
 */
          ...
          while (index < length) {
            if (((startIndex = text.indexOf(startSymbol, index)) != -1) &&
              ((endIndex = text.indexOf(endSymbol, startIndex +
                startSymbolLength)) != -1)) {
              (index != startIndex) && parts.push(text.substring(index,
                startIndex));
              parts.push(fn = $parse(exp = text.substring(startIndex +
  ...
  function parseAbsoluteUrl(absoluteUrl, locationObj, appBase) {
    ...
    locationObj.$$port = int(parsedUrl.port) || DEFAULT_PORTS[parsedUrl.protocol] ||
      null;
  }
  ...
  function parseAppUrl(relativeUrl, locationObj, appBase) {
    ...
    locationObj.$$path = decodeURIComponent(prefixed && match.pathname.charAt(
        0) === '/' ?
  ...
  function LocationHashbangUrl(appBase, hashPrefix) {
     ...
     */
    this.$$parse = function (url) {
      var withoutBaseUrl = beginsWith(appBase, url) || beginsWith(
        appBaseNoFile, url);
      var withoutHashUrl = withoutBaseUrl.charAt(0) == '#' ? beginsWith(
        hashPrefix, withoutBaseUrl) : (this.$$html5) ? withoutBaseUrl : '';
      ...
      function ($rootScope, $browser, $sniffer, $rootElement) {
          ...
          if (LocationMode === LocationHashbangInHtml5Url) {
            ...
            if (href.indexOf('://') < 0) { // Ignore absolute URLs
              ...
              if (href[0] == '/') {
                ...
                // local anchor
                absHref = appBase + prefix + ($location.path() || '/') +
                  href;
              } else {
        ...
        $rootScope.$watch(function $locationWatch() {
          ...
          if (!changeCounter || oldUrl != $location.absUrl()) {
            changeCounter++;
            $rootScope.$evalAsync(function () {
              if ($rootScope.$broadcast('$locationChangeStart', $location
                .absUrl(), oldUrl).defaultPrevented) {
                $location.$$parse(oldUrl);
              } else {
 ...
 */
  ...
  function ensureSafeMemberName(name, fullExpression) {
    if (name === "__defineGetter__" || name === "__defineSetter__" || name ===
  ...
  Parser.prototype = {
    ...
    throwError: function (msg, token) {
      throw $parseMinErr('syntax',
        ...
        token.text, msg, (token.index + 1), this.text, this.text.substring(
          token.index));
    },
    ...
    statements: function () {
      ...
      while (true) {
        ...
        if (!this.expect(';')) {
          ...
          return (statements.length === 1) ? statements[0] : function (self,
            locals) {
            var value;
    ...
    functionCall: function (fn, contextGetter) {
      ...
      return function (scope, locals) {
        ...
        var v = fnPtr.apply ? fnPtr.apply(context, args) : fnPtr(args[0],
  ...
  function simpleGetterFn1(key0, fullExp) {
    ...
    return function simpleGetterFn1(scope, locals) {
      ...
      return ((locals && locals.hasOwnProperty(key0)) ? locals : scope)[
        key0];
    };
  }
  ...
  function getterFn(path, options, fullExp) {
    ...
    if (!options.unwrapPromises && pathKeysLength === 1) {
      ...
      if (pathKeysLength < 6) {
        fn = cspSafeGetterFn(pathKeys[0], pathKeys[1], pathKeys[2], pathKeys[
            3], pathKeys[4], fullExp,
          options);
      } else {
    ...
    this.$get = ['$filter', '$sniffer', '$log',
      function ($filter, $sniffer, $log) {
        ...
        promiseWarning = function promiseWarningFn(fullExp) {
          if (!$parseOptions.logPromiseWarnings || promiseWarningCache.hasOwnProperty(
            fullExp)) return;
     ...
     */
       ...
       */
                    ...
                    try {
                      ...
                      if (watch) {
                        if ((value = watch.get(current)) !== (last = watch.last) &&
                          !(watch.eq ? equals(value, last) : (typeof value ===
                            'number' && typeof last === 'number' && isNaN(
                              value) && isNaN(last)))) {
                          dirty = true;
                          lastDirtyWatch = watch;
                          watch.last = watch.eq ? copy(value, null) : value;
                          watch.fn(value, ((last === initWatchVal) ? value :
                            last), current);
                          if (ttl < 5) {
                            logIdx = 4 - ttl;
                            if (!watchLog[logIdx]) watchLog[logIdx] = [];
                            logMsg = (isFunction(watch.exp)) ? 'fn: ' + (
                              watch.exp.name || watch.exp.toString()) : watch
                              .exp;
          ...
          $destroy: function () {
            ...
            forEach(this.$$listenerCount, bind(null, decrementListenerCount,
              this));
  ...
  function $SceDelegateProvider() {
    ...
    this.$get = ['$injector',
      function ($injector) {
        ...
        byType[SCE_CONTEXTS.RESOURCE_URL] = generateHolderType(byType[
          SCE_CONTEXTS.URL]);
  ...
  function $SnifferProvider() {
    this.$get = ['$window', '$document',
      function ($window, $document) {
        var eventSupport = {},
          android =
          int((/android (\d+)/.exec(lowercase(($window.navigator || {}).userAgent)) || [])[
            1]),
          ...
          comparator = function (obj, text) {
            if (obj && text && typeof obj === 'object' && typeof text ===
              ...
              for (var objKey in obj) {
                if (objKey.charAt(0) !== '$' && hasOwnProperty.call(obj,
                    objKey) &&
 ...
 */
  ...
  function formatNumber(number, pattern, groupSep, decimalSep, fractionSize) {
    ...
    if (!hasExponent) {
      ...
      if (fractionSize && fractionSize !== "0") formatedText += decimalSep +
  ...
  function FormController(element, attrs, $scope, $animate) {
    ...
    function toggleValidCss(isValid, validationErrorKey) {
      validationErrorKey = validationErrorKey ? '-' + snake_case(
        validationErrorKey, '-') : '';
      $animate.removeClass(element, (isValid ? INVALID_CLASS : VALID_CLASS) +
        validationErrorKey);
...
*/
  ...
  function textInputType(scope, element, attr, ctrl, $sniffer, $browser) {
    ...
    if (pattern) {
      var validateRegex = function (regexp, value) {
        return validate(ctrl, 'pattern', ctrl.$isEmpty(value) || regexp.test(
          value), value);
      };
  ...
  function numberInputType(scope, element, attr, ctrl, $sniffer, $browser) {
    ...
    ctrl.$formatters.push(function (value) {
      return validate(ctrl, 'number', ctrl.$isEmpty(value) || isNumber(
        value), value);
    });
  }
  ...
  function urlInputType(scope, element, attr, ctrl, $sniffer, $browser) {
    ...
    var urlValidator = function (value) {
      return validate(ctrl, 'url', ctrl.$isEmpty(value) || URL_REGEXP.test(
        value), value);
    };
  ...
  function emailInputType(scope, element, attr, ctrl, $sniffer, $browser) {
    ...
    var emailValidator = function (value) {
      return validate(ctrl, 'email', ctrl.$isEmpty(value) || EMAIL_REGEXP.test(
        value), value);
    };
      ...
      return {
        ...
        compile: function (element, attr) {
          ...
          return function (scope, $element, $attr, ctrl, $transclude) {
            ...
            scope.$watch($sce.parseAsResourceUrl(srcExp), function ngIncludeWatchAction(
              src) {
        ...
        link: function (scope, element, attr) {
          ...
          forEach(attr, function (expression, attributeName) {
            if (isWhen.test(attributeName)) {
              whens[lowercase(attributeName.replace('when', '').replace(
                'Minus', '-'))] =
          ...
          scope.$watch(function ngPluralizeWatch() {
            ...
            if (!isNaN(value)) {
              ...
              if (!(value in whens)) value = $locale.pluralCat(value -
                offset);
      ...
      return {
        ...
        link: function ($scope, $element, $attr, ctrl, $transclude) {
          ...
          $scope.$watchCollection(rhs, function ngRepeatAction(collection) {
            ...
            for (index = 0, length = collectionKeys.length; index <
              length; index++) {
              key = (collection === collectionKeys) ? index :
                collectionKeys[index];
              value = collection[key];
        ...
        link: function (scope, element, attr, ngSwitchController) {
          ...
          scope.$watch(watchExpr, function ngSwitchWatchAction(value) {
            ...
            if ((selectedTranscludes = ngSwitchController.cases['!' +
              value] || ngSwitchController.cases['?'])) {
    ...
    function ($compile, $parse) {
      ...
      return {
        ...
        link: function (scope, element, attr, ctrls) {
          ...
          // find "null" option
          for (var i = 0, children = element.children(), ii = children.length; i <
            ii; i++) {
            if (children[i].value === '') {
          ...
          function setupAsOptions(scope, selectElement, ctrl) {
            ...
            function render() {
              ...
              if (multiple) {
                if (trackFn && isArray(modelValue)) {
                  ...
                  for (var trackIndex = 0; trackIndex < modelValue.length; trackIndex++) {
                    ...
                    selectedSet.put(trackFn(scope, locals), modelValue[
                      trackIndex]);
                  }
                } else {
              ...
              for (index = 0; length = keys.length, index < length; index++) {
                ...
                if (multiple) {
                  selected = isDefined(
                    selectedSet.remove(trackFn ? trackFn(scope, locals) :
                ...
                optionGroup.push({
                  ...
                  id: trackFn ? trackFn(scope, locals) : (keyName ? keys[
                    index] : index),
                  label: label,
