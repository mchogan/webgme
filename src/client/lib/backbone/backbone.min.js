(function (t, e) {
        ...
        if (a = this._events[t]) {
          ...
          if (e || r) {
            for (l = 0, f = a.length; l < f; l++) {
              n = a[l];
              if (e && e !== n.callback && e !== n.callback._callback || r &&
                r !== n.context) {
                s.push(n)
              }
            }
  ...
  e.sync = function (t, r, s) {
    ...
    if (s.data == null && r && (t === "create" || t === "update" || t ===
      "patch")) {
  ...
  var k = typeof window !== "undefined" && !!window.ActiveXObject && !(window
    .XMLHttpRequest && (new XMLHttpRequest).dispatchEvent);
  var T = {
    create: "POST",
    update: "PUT",
    patch: "PATCH",
  ...
  i.extend($.prototype, u, {
    ...
    _routeToRegExp: function (t) {
      t = t.replace(I, "\\$&").replace(S, "(?:$1)?").replace(H, function (t,
        e) {
        return e ? t : "([^/?]+)"
      }).replace(A, "([^?]*?)");
  ...
  i.extend(N.prototype, u, {
    ...
    navigate: function (t, e) {
      ...
      if (this._hasPushState) {
        this.history[e.replace ? "replaceState" : "pushState"]({}, document
          .title, i)
      } else if (this._wantsHashChange) {
