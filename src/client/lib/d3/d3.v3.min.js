d3 = function () {
  ...
  function c(n) {
    function t() {
      for (var t, r = e, i = -1, u = r.length; ++i < u;)(t = r[i].on) && t.apply(
        this, arguments);
      return n
    }
    var e = [],
    ...
    return t.on = function (t, i) {
      var u, a = r.get(t);
      return arguments.length < 2 ? a && a.on : (a && (a.on = null, e = e.slice(
          0, u = e.indexOf(a)).concat(e.slice(u + 1)), r.remove(t)), i && e
        .push(r.set(t, {
          on: i
        })), n)
    }, t
  ...
  function h(n) {
    for (var t = new o, e = 0, r = arguments.length; ++e < r;) t[arguments[e]] =
      c(t);
  ...
  function g(n, t) {
    ...
    if (e.createSVGPoint) {
      ...
      if (0 > pa && (oa.scrollX || oa.scrollY)) {
        e = ua.select(aa.body).append("svg").style("position", "absolute").style(
          "top", 0).style("left", 0);
        var i = e[0][0].getScreenCTM();
        pa = !(i.f || i.e), e.remove()
      }
      return pa ? (r.x = t.pageX, r.y = t.pageY) : (r.x = t.clientX, r.y = t.clientY),
  ...
  function M(n, t) {
    ...
    function o() {
      var e = t.apply(this, arguments);
      null == e ? this.removeAttributeNS(n.space, n.local) : this.setAttributeNS(
        n.space, n.local, e)
    }
    return n = ua.ns.qualify(n), null == t ? n.local ? r : e : "function" ==
      typeof t ? n.local ? o : a : n.local ? u : i
  }
  ...
  function S(n) {
    ...
    return function (e, r) {
      ...
      r ? (t.lastIndex = 0, t.test(i) || e.setAttribute("class", x(i + " " +
        n))) : e.setAttribute("class", x(i.replace(t, " ")))
    }
  }
  ...
  function j(n, t) {
    for (var e = 0, r = n.length; r > e; e++)
      for (var i, u = n[e], a = 0, o = u.length; o > a; a++)(i = u[a]) && t(i,
        a, e);
    return n
  }
  ...
  function R(n, t, e) {
    function r(n) {
      return n > 360 ? n -= 360 : 0 > n && (n += 360), 60 > n ? u + (a - u) * n /
        60 : 180 > n ? a : 240 > n ? u + (a - u) * (240 - n) / 60 : u
    }
    ...
    var u, a;
    return n = isNaN(n) ? 0 : (n %= 360) < 0 ? n + 360 : n, t = isNaN(t) ? 0 :
      0 > t ? 0 : t > 1 ? 1 : t, e = 0 > e ? 0 : e > 1 ? 1 : e, a = .5 >= e ? e *
      (1 + t) : e + t - e * t, u = 2 * e - a, et(i(n + 120), i(n), i(n - 120))
  }
  ...
  function $(n, t, e) {
    return isNaN(n) && (n = 0), isNaN(t) && (t = 0), J(e, Math.cos(n *= La) * t,
      Math.sin(n) * t)
  }
  ...
  function K(n, t, e) {
    var r = (n + 16) / 116,
      i = r + t / 500,
      u = r - e / 200;
    return i = Q(i) * Ra, r = Q(r) * Oa, u = Q(u) * Ya, et(tt(3.2404542 * i - 1
      .5371385 * r - .4985314 * u), tt(-.969266 * i + 1.8760108 * r + .041556 *
      u), tt(.0556434 * i - .2040259 * r + 1.0572252 * u))
  }

  function W(n, t, e) {
    return n > 0 ? Z(Math.atan2(e, t) * Fa, Math.sqrt(t * t + e * e), n) : Z(0 /
      0, 0 / 0, n)
  }
  ...
  function tt(n) {
    return Math.round(255 * (.00304 >= n ? 12.92 * n : 1.055 * Math.pow(n, 1 /
      2.4) - .055))
  }
  ...
  function it(n) {
    return 16 > n ? "0" + Math.max(0, n).toString(16) : Math.min(255, n).toString(
      16)
  }
  ...
  function ut(n, t, e) {
    ...
    case "hsl":
      return e(parseFloat(i[0]), parseFloat(i[1]) / 100, parseFloat(i[2]) /
        100);
    case "rgb":
      return t(lt(i[0]), lt(i[1]), lt(i[2]))
    }
    return (u = Va.get(n)) ? t(u.r, u.g, u.b) : (null != n && n.charAt(0) ===
      "#" && (n.length === 4 ? (a = n.charAt(1), a += a, o = n.charAt(2), o +=
        o, c = n.charAt(3), c += c) : n.length === 7 && (a = n.substring(1,
        3), o = n.substring(3, 5), c = n.substring(5, 7)), a = parseInt(a,
        16), o = parseInt(o, 16), c = parseInt(c, 16)), t(a, o, c))
  }
  ...
  function at(n, t, e) {
    var r, i, u = Math.min(n /= 255, t /= 255, e /= 255),
      ...
      o = a - u,
      c = (a + u) / 2;
    return o ? (i = .5 > c ? o / (a + u) : o / (2 - a - u), r = n == a ? (t - e) /
      o + (e > t ? 6 : 0) : t == a ? (e - n) / o + 2 : (n - t) / o + 4, r *=
      60) : (r = 0 / 0, i = c > 0 && 1 > c ? 0 : r), H(r, i, c)
  }
    ...
    return e.parse = function (n, t) {
      ...
      function e() {
        ...
        if (n.charCodeAt(t) === 34) {
          ...
          return 13 === r ? (i = !0, n.charCodeAt(e + 2) === 10 && ++f) : 10 ===
            r && (i = !0), n.substring(t + 1, e).replace(/""/g, '"')
        }
        for (; c > f;) {
  ...
  function pt() {
    for (var n, t = Date.now(), e = Ja; e;) n = t - e.then, n >= e.delay && (e.flush =
      e.callback(n)), e = e.next;
    var r = dt() - t;
    r > 24 ? (isFinite(r) && (clearTimeout(Za), Za = setTimeout(pt, r)), Xa = 0) :
      (Xa = 1, Ga(pt))
  }

  function dt() {
    for (var n = null, t = Ja, e = 1 / 0; t;) t.flush ? (delete $a[t.callback.id],
      t = n ? n.next = t.next : Ja = t.next) : (e = Math.min(e, t.then + t.delay),
      t = (n = t).next);
    return e
  }
  ...
  function _t() {
    ...
    lo.point = function (a, o) {
      lo.point = n, r = (t = a) * La, i = Math.cos(o = (e = o) * La / 2 + Da /
        4), u = Math.sin(o)
    }, lo.lineEnd = function () {
      n(t, e)
    }
  ...
  function Et(n, t) {
    return [n[1] * t[2] - n[2] * t[1], n[2] * t[0] - n[0] * t[2], n[0] * t[1] -
      n[1] * t[0]
    ]
  }
  ...
  function Ct(n, t) {
    if (!fo) {
      ++so, n *= La;
      var e = Math.cos(t *= La);
      ho += (e * Math.cos(n) - ho) / so, go += (e * Math.sin(n) - go) / so, po +=
        (Math.sin(t) - po) / so
    }
  }
  ...
  function Dt() {
    function n(n, i) {
      ...
      var u = Math.cos(i *= La),
        ...
        o = u * Math.sin(n),
        c = Math.sin(i),
        l = Math.atan2(Math.sqrt((l = e * c - r * o) * l + (l = r * a - t * c) *
          l + (l = t * o - e * a) * l), t * a + e * o + r * c);
      so += l, ho += l * (t + (t = a)), go += l * (e + (e = o)), po += l * (r +
        (r = c))
    }
    var t, e, r;
    fo > 1 || (1 > fo && (fo = 1, so = ho = go = po = 0), mo.point = function (
      i, u) {
      i *= La;
      var a = Math.cos(u *= La);
  ...
  function Ft(n, t, e, r, i) {
    ...
    if (n.forEach(function (n) {
      ...
      if (e)
        for (var o = 1, c = !e(a[0].point), l = a.length; l > o; ++o) a[o].entry =
          c = !c;
      for (var f, s, h, g = u[0];;) {
        for (f = g; f.visited;)
  ...
  function Ht(n) {
    if (t = n.length) {
      for (var t, e, r = 0, i = n[0]; ++r < t;) i.next = e = n[r], e.prev = i,
        i = e;
  ...
  function Pt(n, t, e) {
    return function (r) {
      ...
      function f() {
        ...
        i > 1 && 2 & t && e.push(e.pop().concat(e.shift())), s.push(e.filter(
          Rt))
      }
      var s, h, g, p, d, m = t(r),
        v = {
          ...
          polygonStart: function () {
            v.point = c, v.lineStart = l, v.lineEnd = f, p = !1, g = h = 0, s = [],
              r.polygonStart()
          },
          polygonEnd: function () {
            v.point = i, v.lineStart = a, v.lineEnd = o, s = ua.merge(s), s.length ?
              Ft(s, Ut, null, e, r) : (-ja > h || p && -ja > g) && (r.lineStart(),
                e(null, null, 1, r), r.lineEnd()), r.polygonEnd(), s = null
          },
          sphere: function () {
            r.polygonStart(), r.lineStart(), e(null, null, 1, r), r.lineEnd(),
              r.polygonEnd()
          }
        },
        y = Ot(),
  ...
  function Yt(n, t) {
    ...
    for (var e, r, i, u = 0, a = 0, o = n[0], c = o[0], l = o[1], f = Math.cos(
        l), s = Math.atan2(t * Math.sin(c) * f, Math.sin(l)), h = 1 - t *
      Math.cos(c) * f, g = s; ++u < e;) o = n[u], f = Math.cos(l = o[1]), r =
      Math.atan2(t * Math.sin(c = o[0]) * f, Math.sin(l)), i = 1 - t * Math.cos(
        c) * f, Math.abs(h - 2) < ja && Math.abs(i - 2) < ja || (Math.abs(i) <
        ja || Math.abs(h) < ja || (Math.abs(Math.abs(r - s) - Da) < ja ? i + h >
          2 && (a += 4 * (r - s)) : a += Math.abs(h - 2) < ja ? 4 * (r - g) : (
            (3 * Da + r - s) % (2 * Da) - Da) * (h + i)), g = s, s = r, h = i);
    return a
  }

  function Ut(n, t) {
    return ((n = n.point)[0] < 0 ? n[1] - Da / 2 - ja : Da / 2 - n[1]) - ((t =
      t.point)[0] < 0 ? t[1] - Da / 2 - ja : Da / 2 - t[1])
  }
  ...
  function It(n) {
    ...
    return {
      ...
      point: function (u, a) {
        var o = u > 0 ? Da : -Da,
          c = Math.abs(u - e);
        Math.abs(c - Da) < ja ? (n.point(e, r = (r + a) / 2 > 0 ? Da / 2 : -Da /
          2), n.point(i, r), n.lineEnd(), n.lineStart(), n.point(o, r), n.point(
          u, r), t = 0) : i !== o && c >= Da && (Math.abs(e - i) < ja && (e -=
            i * ja), Math.abs(u - o) < ja && (u -= o * ja), r = Vt(e, r, u, a),
          n.point(i, r), n.lineEnd(), n.lineStart(), n.point(o, r), t = 0), n.point(
          e = u, r = a), i = o
      },
      lineEnd: function () {
        n.lineEnd(), e = r = 0 / 0
  ...
  function Vt(n, t, e, r) {
    ...
    return Math.abs(a) > ja ? Math.atan((Math.sin(t) * (u = Math.cos(r)) * Math
        .sin(e) - Math.sin(r) * (i = Math.cos(t)) * Math.sin(n)) / (i * u * a)) :
      (t + r) / 2
  }

  function Xt(n, t, e, r) {
    var i;
    if (null == n) i = e * Da / 2, r.point(-Da, i), r.point(0, i), r.point(Da,
        i), r.point(Da, 0), r.point(Da, -i), r.point(0, -i), r.point(-Da, -i),
      r.point(-Da, 0), r.point(-Da, i);
  ...
  function Zt(n) {
    ...
    function e(n) {
      ...
      return {
        ...
        point: function (s, h) {
          ...
          if (!e && (l = c = d) && n.lineStart(), d !== c && (g = r(e, p), (Tt(
              e, g) || Tt(p, g)) && (p[0] += ja, p[1] += ja, d = t(p[0], p[1]))),
            d !== c) f = 0, d ? (n.lineStart(), g = r(p, e), n.point(g[0], g[1])) :
            (g = r(e, p), n.point(g[0], g[1]), n.lineEnd()), e = g;
          else if (o && e && a ^ d) {
            var v;
            m & u || !(v = r(p, e, !0)) || (f = 0, a ? (n.lineStart(), n.point(
              v[0][0], v[0][1]), n.point(v[1][0], v[1][1]), n.lineEnd()) : (n
              .point(v[1][0], v[1][1]), n.lineEnd(), n.lineStart(), n.point(v[
                0][0], v[0][1])))
    ...
    function r(n, t, e) {
      ...
      if (!(0 > M)) {
        ...
        var A = S - w,
          N = Math.abs(A - Da) < ja,
          q = N || ja > A;
        if (!N && E > k && (_ = E, E = k, k = _), q ? N ? E + k > 0 ^ b[1] < (
            Math.abs(b[0] - w) < ja ? E : k) : E <= b[1] && b[1] <= k : A > Da ^
          (w <= b[0] && b[0] <= S)) {
          var T = At(m, (-v + x) / y);
    ...
    function i(t, e) {
      var r = a ? n : Da - n,
        i = 0;
      return -r > t ? i |= 1 : t > r && (i |= 2), -r > e ? i |= 4 : e > r && (i |=
        8), i
    }
    var u = Math.cos(n),
      a = u > 0,
  ...
  function Bt(n, t, e, r) {
    function i(r, i) {
      return Math.abs(r[0] - n) < ja ? i > 0 ? 0 : 3 : Math.abs(r[0] - e) < ja ?
        i > 0 ? 2 : 1 : Math.abs(r[1] - t) < ja ? i > 0 ? 1 : 0 : i > 0 ? 3 : 2
    }
    ...
    function a(n, t) {
      var e = i(n, 1),
        r = i(t, 1);
      return e !== r ? e - r : 0 === e ? t[1] - n[1] : 1 === e ? n[0] - t[0] :
        2 === e ? n[1] - t[1] : t[0] - n[0]
    }
    ...
    function o(i, u) {
      var a = u[0] - i[0],
        o = u[1] - i[1],
        c = [0, 1];
      return Math.abs(a) < ja && Math.abs(o) < ja ? n <= i[0] && i[0] <= e && t <=
        i[1] && i[1] <= r : $t(n - i[0], a, c) && $t(i[0] - e, -a, c) && $t(t -
          i[1], o, c) && $t(i[1] - r, -o, c) ? (c[1] < 1 && (u[0] = i[0] + c[1] *
          a, u[1] = i[1] + c[1] * o), c[0] > 0 && (i[0] += c[0] * a, i[1] +=
          c[0] * o), !0) : !1
    }
    return function (c) {
      function l(u) {
      ...
      function f(n) {
        for (var t = 0, e = M.length, r = n[1], i = 0; e > i; ++i)
          for (var u = 1, a = M[i], o = a.length, c = a[0]; o > u; ++u) b = a[
              u], c[1] <= r ? b[1] > r && s(c, b, n) > 0 && ++t : b[1] <= r &&
            s(c, b, n) < 0 && --t, c = b;
        return 0 !== t
      }
      ...
      function h(u, o, c, l) {
        var f = 0,
          s = 0;
        if (null == u || (f = i(u, c)) !== (s = i(o, c)) || a(u, o) < 0 ^ c >
          0) {
          do l.point(0 === f || 3 === f ? n : e, f > 1 ? r : t); while ((f =
            (f + c + 4) % 4) !== s)
      ...
      function m() {
        y && (v(_, w), S && A && T.rejoin(), y.push(T.buffer())), C.point = p,
          A && c.lineEnd()
      }
      ...
      function v(n, t) {
        ...
        var e = g(n, t);
        if (M && x.push([n, t]), N) _ = n, w = t, S = e, N = !1, e && (c.lineStart(),
          c.point(n, t));
        else if (e && A) c.point(n, t);
        else {
          var r = [E, k],
            i = [n, t];
          o(r, i) ? (A || (c.lineStart(), c.point(r[0], r[1])), c.point(i[0],
            i[1]), e || c.lineEnd()) : e && (c.lineStart(), c.point(n, t))
        }
        E = n, k = t, A = e
      }
      var y, M, x, _, w, S, E, k, A, N, q = c,
        ...
        C = {
          ...
          polygonEnd: function () {
            c = q, (y = ua.merge(y)).length ? (c.polygonStart(), Ft(y, u, l,
              h, c), c.polygonEnd()) : f([n, t]) && (c.polygonStart(), c.lineStart(),
              h(null, null, 1, c), c.lineEnd(), c.polygonEnd()), y = M = x =
              null
          }
        };
      return C
  ...
  function Gt(n) {
    function t(t) {
      ...
      function a(r, u) {
        var a = wt([r, u]),
          o = n(r, u);
        e(f, s, l, h, g, p, f = o[0], s = o[1], l = r, h = a[0], g = a[1], p =
          a[2], i, t), t.point(f, s)
      }
    ...
    function e(t, i, u, a, o, c, l, f, s, h, g, p, d, m) {
      ...
      if (M > 4 * r && d--) {
        var x = a + h,
          ...
          T = N - i,
          C = y * q - v * T;
        (C * C / M > r || Math.abs((v * q + y * T) / M - .5) > .3) && (e(t, i,
          u, a, o, c, A, N, E, x /= w, b /= w, _, d, m), m.point(A, N), e(A,
          N, E, x, b, _, l, f, s, h, g, p, d, m))
      }
    }
    var r = .5,
      i = 16;
  ...
  function Wt(n) {
    ...
    function e(n) {
      return n = a.invert((n[0] - o) / f, (c - n[1]) / f), n && [n[0] * Fa, n[1] *
        Fa
      ]
    }
    ...
    return t.stream = function (n) {
        ...
        return arguments.length ? (y = null == n ? (x = n, vo) : Zt((x = +n) *
          La), t) : x
      }, t.clipExtent = function (n) {
        return arguments.length ? (b = n, M = null == n ? st : Bt(n[0][0], n[0]
          [1], n[1][0], n[1][1]), t) : b
      }, t.scale = function (n) {
        ...
        return arguments.length ? (d = n[0] % 360 * La, m = n[1] % 360 * La, v =
          n.length > 2 ? n[2] % 360 * La : 0, r()) : [d * Fa, m * Fa, v * Fa]
  ...
  function Qt(n, t) {
    return {
      point: function (e, r) {
        r = n(e * La, r * La), e = r[0], t.point(e > Da ? e - 2 * Da : -Da > e ?
          e + 2 * Da : e, r[1])
      },
      sphere: function () {
        t.sphere()
  ...
  function ie(n, t) {
    function e(n, t) {
      var e = Math.cos(t),
        ...
        l = Math.sin(t),
        f = l * r + o * i;
      return [Math.atan2(c * u - f * a, o * r - l * i), Math.asin(Math.max(-1,
        Math.min(1, f * u + c * a)))]
    }
    var r = Math.cos(n),
      i = Math.sin(n),
    ...
    return e.invert = function (n, t) {
      var e = Math.cos(t),
        ...
        l = Math.sin(t),
        f = l * u - c * a;
      return [Math.atan2(c * u + l * a, o * r + f * i), Math.asin(Math.max(-1,
        Math.min(1, f * r - o * i)))]
    }, e
  }
  ...
  function ue(n, t) {
    ...
    return function (i, u, a, o) {
      null != i ? (i = ae(e, i), u = ae(e, u), (a > 0 ? u > i : i > u) && (i +=
        2 * a * Da)) : (i = n + 2 * a * Da, u = n);
      for (var c, l = a * t, f = i; a > 0 ? f > u : u > f; f -= l) o.point((c =
        qt([e, -r * Math.cos(f), -r * Math.sin(f)]))[0], c[1])
    }
  }
    ...
    var i = Math.cos(t),
      ...
      p = h ? function (n) {
        var t = Math.sin(n *= h) * g,
          ...
          i = e * l + t * s,
          a = e * u + t * o;
        return [Math.atan2(i, r) * Fa, Math.atan2(a, Math.sqrt(r * r + i * i)) *
          Fa
        ]
      } : function () {
        return [n * Fa, t * Fa]
  ...
  function he() {
    function n(n, i) {
      var u = Math.sin(i *= La),
        ...
        o = Math.abs((n *= La) - t),
        c = Math.cos(o);
      Mo += Math.atan2(Math.sqrt((o = a * Math.sin(o)) * o + (o = r * u - e * a *
        c) * o), e * u + r * a * c), t = n, e = u, r = a
    }
    var t, e, r;
  ...
  function me(n, t) {
    wo > n && (wo = n), n > Eo && (Eo = n), So > t && (So = t), t > ko && (ko =
      t)
  }
  ...
  function ke(n, t) {
    ...
    var r = Math.cos(n),
      ...
      u = n === t ? Math.sin(n) : Math.log(r / Math.cos(t)) / Math.log(i(t) / i(
        n)),
      a = r * Math.pow(i(n), u) / u;
    return u ? (e.invert = function (n, t) {
      var e = a - t,
        r = O(u) * Math.sqrt(n * n + e * e);
      return [Math.atan2(n, e) / u, 2 * Math.atan(Math.pow(a / r, 1 / u)) -
        Da / 2
      ]
    }, e) : Ne
  }
  ...
  function Ce(n) {
    function t(t) {
      ...
      for (var c, l = [], f = [], s = -1, h = t.length, g = ft(e), p = ft(r); ++
        s < h;) i.call(this, c = t[s], s) ? f.push([+g.call(this, c, s), +p.call(
        this, c, s)]) : f.length && (a(), f = []);
    ...
    return t.x = function (n) {
      ...
      return arguments.length ? (a = "function" == typeof n ? u = n : (u = Lo
        .get(n) || je).key, t) : a
  ...
  function Fe(n) {
    for (var t = 0, e = n.length, r = n[0], i = [r[0], ",", r[1]]; ++t < e;) i.push(
      "V", (r = n[t])[1], "H", r[0]);
    return i.join("")
  }
  ...
  function Re(n, t) {
    return n.length < 3 ? je(n) : n[0] + Ye((n.push(n[0]), n), Ue([n[n.length -
      2]].concat(n, [n[1]]), t))
  }
  ...
  function Ye(n, t) {
    if (t.length < 1 || n.length != t.length && n.length != t.length + 2) return
      je(n);
    var e = n.length != t.length,
      ...
      o = a,
      c = 1;
    if (e && (r += "Q" + (u[0] - a[0] * 2 / 3) + "," + (u[1] - a[1] * 2 / 3) +
      "," + u[0] + "," + u[1], i = n[1], c = 2), t.length > 1) {
      o = t[1], u = n[c], c++, r += "C" + (i[0] + a[0]) + "," + (i[1] + a[1]) +
        "," + (u[0] - o[0]) + "," + (u[1] - o[1]) + "," + u[0] + "," + u[1];
      for (var l = 2; l < t.length; l++, c++) u = n[c], o = t[l], r += "S" + (u[
        0] - o[0]) + "," + (u[1] - o[1]) + "," + u[0] + "," + u[1]
    }
    if (e) {
      var f = n[c];
      r += "Q" + (u[0] + o[0] * 2 / 3) + "," + (u[1] + o[1] * 2 / 3) + "," + f[
        0] + "," + f[1]
    }
    return r
  }
  ...
  function Ue(n, t) {
    for (var e, r = [], i = (1 - t) / 2, u = n[0], a = n[1], o = 1, c = n.length; ++
      o < c;) e = u, u = a, a = n[o], r.push([i * (a[0] - e[0]), i * (a[1] - e[
      1])]);
    return r
  }
  ...
  function Ie(n) {
    ...
    var t = 1,
      ...
      o = [u, u, u, r[1]],
      c = [i, ",", u];
    for ($e(c, a, o); ++t < e;) r = n[t], a.shift(), a.push(r[0]), o.shift(), o
      .push(r[1]), $e(c, a, o);
    for (t = -1; ++t < 2;) a.shift(), a.push(r[0]), o.shift(), o.push(r[1]), $e(
      c, a, o);
    return c.join("")
  }
  ...
  function Ve(n) {
    ...
    for (var t, e = [], r = -1, i = n.length, u = [0], a = [0]; ++r < 3;) t = n[
      r], u.push(t[0]), a.push(t[1]);
    for (e.push(Be(Po, u) + "," + Be(Po, a)), --r; ++r < i;) t = n[r], u.shift(),
      u.push(t[0]), a.shift(), a.push(t[1]), $e(e, u, a);
    return e.join("")
  }

  function Xe(n) {
    for (var t, e, r = -1, i = n.length, u = i + 4, a = [], o = []; ++r < 4;) e =
      n[r % i], a.push(e[0]), o.push(e[1]);
    for (t = [Be(Po, a), ",", Be(Po, o)], --r; ++r < u;) e = n[r % i], a.shift(),
      a.push(e[0]), o.shift(), o.push(e[1]), $e(t, a, o);
    return t.join("")
  }
  ...
  function Ze(n, t) {
    var e = n.length - 1;
    if (e)
      for (var r, i, u = n[0][0], a = n[0][1], o = n[e][0] - u, c = n[e][1] - a,
        l = -1; ++l <= e;) r = n[l], i = l / e, r[0] = t * r[0] + (1 - t) * (u +
        i * o), r[1] = t * r[1] + (1 - t) * (a + i * c);
    return Ie(n)
  }
  ...
  function $e(n, t, e) {
    n.push("C", Be(Fo, t), ",", Be(Fo, e), ",", Be(Ho, t), ",", Be(Ho, e), ",",
      Be(Po, t), ",", Be(Po, e))
  }
  ...
  function Ge(n) {
    for (var t = 0, e = n.length - 1, r = [], i = n[0], u = n[1], a = r[0] = Je(
      i, u); ++t < e;) r[t] = (a + (a = Je(i = u, u = n[t + 1]))) / 2;
    return r[t] = a, r
  }

  function Ke(n) {
    for (var t, e, r, i, u = [], a = Ge(n), o = -1, c = n.length - 1; ++o < c;)
      t = Je(n[o], n[o + 1]), Math.abs(t) < 1e-6 ? a[o] = a[o + 1] = 0 : (e = a[
        o] / t, r = a[o + 1] / t, i = e * e + r * r, i > 9 && (i = 3 * t /
        Math.sqrt(i), a[o] = i * e, a[o + 1] = i * r));
    for (o = -1; ++o <= c;) i = (n[Math.min(c, o + 1)][0] - n[Math.max(0, o - 1)]
      [0]) / (6 * (1 + a[o] * a[o])), u.push([i || 0, a[o] * i || 0]);
    return u
  }
  ...
  function Qe(n, t, e, r) {
    var i, u, a, o, c, l, f;
    return i = r[n], u = i[0], a = i[1], i = r[t], o = i[0], c = i[1], i = r[e],
      l = i[0], f = i[1], (f - a) * (o - u) - (c - a) * (l - u) > 0
  }
  ...
  function er(n, t) {
    var e = {
        list: n.map(function (n, t) {
          ...
          return n.y < t.y ? -1 : n.y > t.y ? 1 : n.x < t.x ? -1 : n.x > t.x ?
            1 : 0
        }),
        bottomSite: null
      },
      r = {
        ...
        rightEnd: null,
        init: function () {
          r.leftEnd = r.createHalfEdge(null, "l"), r.rightEnd = r.createHalfEdge(
            null, "l"), r.leftEnd.r = r.rightEnd, r.rightEnd.l = r.leftEnd, r.list
      ...
      i = {
        bisect: function (n, t) {
          var e = {
            ...
            u = r > 0 ? r : -r,
            a = i > 0 ? i : -i;
          return e.c = n.x * r + n.y * i + .5 * (r * r + i * i), u > a ? (e.a =
            1, e.b = i / r, e.c /= r) : (e.b = 1, e.a = r / i, e.c /= i), e
        },
        ...
        rightOf: function (n, t) {
          ...
          if (e.a === 1) {
            var u = t.y - r.y,
              ...
              o = 0,
              c = 0;
            if (!i && e.b < 0 || i && e.b >= 0 ? c = o = u >= e.b * a : (c = t.x +
              t.y * e.b > e.c, e.b < 0 && (c = !c), c || (o = 1)), !o) {
    ...
    for (var a, o, c, l, f, s, h, g, p, d, m, v, y, M = e.list.shift();;)
      if (u.empty() || (a = u.min()), M && (u.empty() || M.y < a.y || M.y == a.y &&
        M.x < a.x)) o = r.leftBound(M), c = r.right(o), h = r.rightRegion(o), v =
        i.bisect(h, M), s = r.createHalfEdge(v, "l"), r.insert(o, s), d = i.intersect(
          o, s), d && (u.del(o), u.insert(o, d, i.distance(d, M))), o = s, s =
        r.createHalfEdge(v, "r"), r.insert(o, s), d = i.intersect(s, c), d && u
        .insert(s, d, i.distance(d, M)), M = e.list.shift();
      else {
        if (u.empty()) break;
        o = u.extractMin(), l = r.left(o), c = r.right(o), f = r.right(c), h =
          r.leftRegion(o), g = r.rightRegion(c), m = o.vertex, i.endPoint(o.edge,
            o.side, m), i.endPoint(c.edge, c.side, m), r.del(o), u.del(c), r.del(
            c), y = "l", h.y > g.y && (p = h, h = g, g = p, y = "r"), v = i.bisect(
            h, g), s = r.createHalfEdge(v, y), r.insert(l, s), i.endPoint(v, Ro[
            y], m), d = i.intersect(l, s), d && (u.del(l), u.insert(l, d, i.distance(
            d, h))), d = i.intersect(s, f), d && u.insert(s, d, i.distance(d, h))
      }
  ...
  function ar(n, t, e, r, i, u) {
    if (!n(t, e, r, i, u)) {
      var a = .5 * (e + i),
        o = .5 * (r + u),
        c = t.nodes;
      c[0] && ar(n, c[0], e, r, a, o), c[1] && ar(n, c[1], a, r, i, o), c[2] &&
        ar(n, c[2], e, o, a, u), c[3] && ar(n, c[3], a, o, i, u)
    }
  }
  ...
  function or(n, t) {
    ...
    var e = n.r,
      ...
      o = t.b - i;
    return function (n) {
      return "#" + it(Math.round(e + u * n)) + it(Math.round(r + a * n)) + it(
        Math.round(i + o * n))
    }
  }
  ...
  function cr(n) {
    ...
    t[0] * e[1] < e[0] * t[1] && (t[0] *= -1, t[1] *= -1, r *= -1, i *= -1),
      ...
      this.translate = [n.e, n.f], this.scale = [r, u], this.skew = u ? Math.atan2(
        i, u) * Fa : 0
  }
  ...
  function gr(n, t) {
    ...
    return o[0] != c[0] || o[1] != c[1] ? (r.push("translate(", null, ",", null,
        ...
        i: 3,
        x: hr(o[1], c[1])
      })) : c[0] || c[1] ? r.push("translate(" + c + ")") : r.push(""), l != f ?
      (l - f > 180 ? f += 360 : f - l > 180 && (l += 360), i.push({
        i: r.push(r.pop() + "rotate(", null, ")") - 2,
        x: hr(l, f)
      })) : f && r.push(r.pop() + "rotate(" + f + ")"), s != h ? i.push({
        i: r.push(r.pop() + "skewX(", null, ")") - 2,
        x: hr(s, h)
      }) : h && r.push(r.pop() + "skewX(" + h + ")"), g[0] != p[0] || g[1] != p[
        1] ? (e = r.push(r.pop() + "scale(", null, ",", null, ")"), i.push({
        i: e - 4,
        x: hr(g[0], p[0])
      }, {
        i: e - 2,
        x: hr(g[1], p[1])
      })) : (p[0] != 1 || p[1] != 1) && r.push(r.pop() + "scale(" + p + ")"), e =
      i.length,
      function (n) {
  ...
  function dr(n, t) {
    var e, r, i, u, a, o = 0,
      ...
      l = [],
      f = [];
    for (n += "", t += "", Yo.lastIndex = 0, r = 0; e = Yo.exec(t); ++r) e.index &&
      l.push(t.substring(o, c = e.index)), f.push({
        i: l.length,
        x: e[0]
    ...
    for (o < t.length && l.push(t.substring(o)), r = 0, u = f.length;
      ...
      if (a = f[r], a.x == e[0]) {
        if (a.i)
          if (l[a.i + 1] == null)
            for (l[a.i - 1] += a.x, l.splice(a.i, 1), i = r + 1; u > i; ++i) f[
              i].i--;
          else
            for (l[a.i - 1] += a.x + l[a.i + 1], l.splice(a.i, 2), i = r + 1; u >
              i; ++i) f[i].i -= 2;
        else if (l[a.i + 1] == null) l[a.i] = a.x;
        else
          for (l[a.i] = a.x + l[a.i + 1], l.splice(a.i + 1, 1), i = r + 1; u >
            i; ++i) f[i].i--;
        f.splice(r, 1), u--, r--
      } else a.x = hr(parseFloat(e[0]), parseFloat(a.x));
    for (; u > r;) a = f.pop(), l[a.i + 1] == null ? l[a.i] = a.x : (l[a.i] = a
      .x + l[a.i + 1], l.splice(a.i + 1, 1)), u--;
  ...
  function mr(n, t) {
    for (var e, r = ua.interpolators.length; --r >= 0 && !(e = ua.interpolators[
      r](n, t)););
    return e
  }
  ...
  function qr(n, t) {
    var e;
    return arguments.length < 2 && (t = .45), arguments.length ? e = t / (2 *
        Da) * Math.asin(1 / n) : (n = 1, e = t / 4),
      function (r) {
  ...
  function Cr(n) {
    return 1 / 2.75 > n ? 7.5625 * n * n : 2 / 2.75 > n ? 7.5625 * (n -= 1.5 /
        2.75) * n + .75 : 2.5 / 2.75 > n ? 7.5625 * (n -= 2.25 / 2.75) * n + .9375 :
  ...
  function zr(n, t) {
    ...
    var e = n.h,
      ...
      a = t.c - r,
      o = t.l - i;
    return isNaN(a) && (a = 0, r = isNaN(r) ? t.c : r), isNaN(u) ? (u = 0, e =
        isNaN(e) ? t.h : e) : u > 180 ? u -= 360 : -180 > u && (u += 360),
      function (n) {
  ...
  function Dr(n, t) {
    ...
    var e = n.h,
      ...
      a = t.s - r,
      o = t.l - i;
    return isNaN(a) && (a = 0, r = isNaN(r) ? t.s : r), isNaN(u) ? (u = 0, e =
        isNaN(e) ? t.h : e) : u > 180 ? u -= 360 : -180 > u && (u += 360),
      function (n) {
  ...
  function Pr(n) {
    for (var t = n.source, e = n.target, r = Or(t, e), i = [t]; t !== r;) t = t
      .parent, i.push(t);
  ...
  function Xr(n, t, e) {
    ...
    if (n.charge = 0, !n.leaf)
      for (var u, a = n.nodes, o = a.length, c = -1; ++c < o;) u = a[c], null !=
        u && (Xr(u, t, e), n.charge += u.charge, r += u.charge * u.cx, i += u.charge *
          u.cy);
    if (n.point) {
      n.leaf || (n.point.x += Math.random() - .5, n.point.y += Math.random() -
        .5);
  ...
  function Zr(n, t) {
    return ua.rebind(n, t, "sort", "children", "value"), n.nodes = n, n.links =
      Gr, n
  }
  ...
  function ai(n, t) {
    for (var e = -1, r = +n[0], i = (n[1] - r) / t, u = []; ++e <= t;) u[e] = i *
      e + r;
    return u
  }
  ...
  function mi(n) {
    for (var t, e = 0, r = 0, i = n.children, u = i.length; --u >= 0;) t = i[u]
      ._tree, t.prelim += e, t.mod += e, e += t.shift + (r += t.change)
  }
  ...
  function wi(n) {
    function t(n) {
      f = Math.min(n.x - n.r, f), s = Math.max(n.x + n.r, s), h = Math.min(n.y -
        n.r, h), g = Math.max(n.y + n.r, g)
    }
    if ((e = n.children) && (l = e.length)) {
      var e, r, i, u, a, o, c, l, f = 1 / 0,
        ...
        h = 1 / 0,
        g = -1 / 0;
      if (e.forEach(Si), r = e[0], r.x = -r.r, r.y = 0, t(r), l > 1 && (i = e[1],
        i.x = i.r, i.y = 0, t(i), l > 2))
        for (u = e[2], Ai(r, i, u), t(u), xi(r, u), r._pack_prev = u, xi(u, i),
          i = r._pack_next, a = 3; l > a; a++) {
          Ai(r, i, u = e[a]);
          var p = 0,
            d = 1,
            m = 1;
          ...
          if (1 == p)
            for (c = r._pack_prev; c !== o._pack_prev && !_i(c, u); c = c._pack_prev,
              m++);
          p ? (m > d || d == m && i.r < r.r ? bi(r, i = o) : bi(r = c, i), a--) :
            (xi(r, u), i = u, t(u))
        }
      var v = (f + s) / 2,
        y = (h + g) / 2,
        M = 0;
      for (a = 0; l > a; a++) u = e[a], u.x -= v, u.y -= y, M = Math.max(M, u.r +
  ...
  function Ai(n, t, e) {
    ...
    if (r && (i || u)) {
      ...
      a *= a, r *= r;
      var c = .5 + (r - a) / (2 * o),
        l = Math.sqrt(Math.max(0, 2 * a * (r + o) - (r -= o) * r - a * a)) / (2 *
          o);
  ...
  function Hi(n, t) {
    var e, r = 0,
      ...
      u = n[r],
      a = n[i];
    return u > a && (e = r, r = i, i = e, e = u, u = a, a = e), (t = t(a - u)) &&
      (n[r] = t.floor(u), n[i] = t.ceil(a)), n
  }
  ...
  function Pi(n, t, e, r) {
    ...
    for (n[o] < n[0] && (n = n.slice().reverse(), t = t.slice().reverse()); ++a <=
      o;) i.push(e(n[a - 1], n[a])), u.push(r(t[a - 1], t[a]));
    return function (t) {
  ...
  function Ui(n, t) {
    var e = ji(n),
      ...
      u = t / r * i;
    return .15 >= u ? i *= 10 : .35 >= u ? i *= 5 : .75 >= u && (i *= 2), e[0] =
      Math.ceil(e[0] / i) * i, e[1] = Math.floor(e[1] / i) * i + .5 * i, e[2] =
      i, e
  }
  ...
  function Xi(n, t, e, r, i) {
    ...
    return u.invert = function (t) {
      ...
      return arguments.length ? (t[0] < 0 ? (e = $i, r = Ji) : (e = Zi, r =
        Bi), n.domain((i = t.map(Number)).map(e)), u) : i
    }, u.base = function (n) {
  ...
  function Gi(n, t, e) {
    ...
    return r.invert = function (t) {
      ...
      return arguments.length ? (i = Ki(t = a), u = Ki(1 / t), n.domain(e.map(
        i)), r) : t
    }, r.copy = function () {
  ...
  function Wi(n, t) {
    ...
    return e.domain = function (r) {
      ...
      n = [], u = new i;
      for (var a, o = -1, c = r.length; ++o < c;) u.has(a = r[o]) || u.set(a,
        n.push(a));
      ...
      var l = i[1] < i[0],
        ...
        g = s - f - (n.length - u) * h;
      return a = r(f + Math.round(g / 2), h), l && a.reverse(), o = Math.round(
        h * (1 - u)), t = {
        t: "rangeRoundBands",
        a: arguments
      }, e
  ...
  function nu(n, t, e) {
    ...
    return r.domain = function (e) {
      return arguments.length ? (n = +e[0], t = +e[e.length - 1], i()) : [n,
        t
      ]
    }, r.range = function (n) {
      return arguments.length ? (e = n, i()) : e
  ...
  function ou(n) {
    for (var t, e, r, i = -1, u = n.length; ++i < u;) t = n[i], e = t[0], r = t[
      1] + tc, t[0] = e * Math.cos(r), t[1] = e * Math.sin(r);
    return n
  }
  ...
  function cu(n) {
    function t(t) {
      ...
      for (var h, g, p, d = [], m = [], v = [], y = -1, M = t.length, x = ft(e),
        b = ft(i), _ = e === r ? function () {
          ...
          return p
        } : ft(u); ++y < M;) a.call(this, h = t[y], y) ? (m.push([g = +x.call(
        this, h, y), p = +b.call(this, h, y)]), v.push([+_.call(this, h, y), +
        w.call(this, h, y)
      ])) : m.length && (c(), m = [], v = []);
    ...
    return t.x = function (n) {
      ...
      return arguments.length ? (c = "function" == typeof n ? o = n : (o = Lo
          .get(n) || je).key, l = o.reverse || o, f = o.closed ? "M" : "L",
        t) : c
    }, t.tension = function (n) {
  ...
  function pu(n) {
    ...
    return "M0," + t + "A" + t + "," + t + " 0 1,1 0," + -t + "A" + t + "," + t +
      " 0 1,1 0," + t + "Z"
  }
  ...
  function yu(n, t, e, r) {
    ...
    if (!a) {
      ...
      return a = u[e] = {
        ...
        function i(r) {
          return u.active > e ? l() : (u.active = e, h.start.call(n, f, t),
        ...
        function c(r) {
          ...
          for (var i = (r - g) / p, a = s(i), o = d.length; o > 0;) d[--o].call(
            n, a);
  ...
  function bu(n, t, e) {
    if (r = [], e && t.length > 1) {
      for (var r, i, u, a = ji(n.domain()), o = -1, c = t.length, l = (t[1] - t[
        0]) / ++e; ++o < c;)
  ...
  function wu(n, t, e) {
    ...
    var c = n.utc = Su(n);
    return c.floor = c, c.round = Su(r), c.ceil = Su(i), c.offset = Su(u), c.range =
      o, n
  }
  ...
  function Au(n) {
    for (var t = new i, e = -1, r = n.length; ++e < r;) t.set(n[e].toLowerCase(),
      e);
    return t
  }
  ...
  function $u(n, t, e) {
    ...
    return r.invert = function (t) {
      ...
      if ("function" != typeof e) {
        ...
        Math.log(o / Fc[c - 1]) < Math.log(Fc[c] / o) && --c, e = t[c], i = e[
          1], e = e[0].range
      }
  ...
  ua.ascending = function (n, t) {
    ...
    if (arguments.length === 1) {
      ...
      for (; ++u < a && ((e = i = t.call(n, n[u], u)) == null || e != e);) e =
        void 0;
      for (; ++u < a;)(r = t.call(n, n[u], u)) != null && (e > r && (e = r), r >
        i && (i = r))
    }
    return [e, i]
  }, ua.sum = function (n, t) {
    ...
    return arguments.length > 1 && (t = t.map(e)), t = t.filter(n), t.length ?
      ua.quantile(t.sort(ua.ascending), .5) : void 0
  }, ua.bisector = function (n) {
    return {
      left: function (t, e, r, i) {
        for (arguments.length < 3 && (r = 0), arguments.length < 4 && (i = t.length); i >
          r;) {
          var u = r + i >>> 1;
  ...
  ua.bisectLeft = sa.left, ua.bisect = ua.bisectRight = sa.right, ua.shuffle =
    function (n) {
      for (var t, e, r = n.length; r;) e = Math.random() * r-- | 0, t = n[r], n[
        r] = n[e], n[e] = t;
      return n
    ...
    forEach: function (n) {
      for (var t in this) t.charCodeAt(0) === ga && n.call(this, t.substring(
        1), this[t])
    }
  });
  var ha = "\0",
  ...
  ua.nest = function () {
    ...
    for (var e, r = 1, i = arguments.length; ++r < i;) n[e = arguments[r]] = a(
      n, t, t[e]);
    return n
  }, ua.dispatch = function () {
    for (var n = new o, t = -1, e = arguments.length; ++t < e;) n[arguments[t]] =
      c(n);
    return n
  ...
  ua.touches = function (n, t) {
    ...
    function t() {
      ...
      function i() {
        o({
          type: "dragend"
        }), g && (l(), ua.event.target === c && s(p, "click")), p.on(null != f ?
          "touchmove.drag-" + f : "mousemove.drag", null).on(null != f ?
          "touchend.drag-" + f : "mouseup.drag", null)
      }
      var u, a = this,
        o = e.of(a, arguments),
        c = ua.event.target,
        ...
        h = n(),
        g = 0,
        p = ua.select(oa).on(null != f ? "touchmove.drag-" + f :
          "mousemove.drag", t).on(null != f ? "touchend.drag-" + f :
          "mouseup.drag", i, !0);
      r ? (u = r.apply(a, arguments), u = [u.x - h[0], u.y - h[1]]) : u = [0, 0],
        null == f && l(), o({
          type: "dragstart"
        })
    }
  ...
  var ya = function (n, t) {
    ...
    ba = xa.matchesSelector || xa.webkitMatchesSelector || xa.mozMatchesSelector ||
    xa.msMatchesSelector || xa.oMatchesSelector,
    _a = function (n, t) {
      return ba.call(n, t)
    };
  ...
  wa.select = function (n) {
    ...
    for (var a = -1, o = this.length; ++a < o;) {
      ...
      for (var c = -1, l = r.length; ++c < l;)(i = r[c]) ? (t.push(e = n.call(i,
          i.__data__, c)), e && "__data__" in i && (e.__data__ = i.__data__)) :
        t.push(null)
    }
    return m(u)
    ...
    for (var i = -1, u = this.length; ++i < u;)
      for (var a = this[i], o = -1, c = a.length; ++o < c;)(e = a[o]) && (r.push(
        t = da(n.call(e, e.__data__, o))), t.parentNode = e);
    return m(r)
  };
  var Sa = {
  ...
  ua.ns = {
    ...
    qualify: function (n) {
      var t = n.indexOf(":"),
        e = n;
      return t >= 0 && (e = n.substring(0, t), n = n.substring(t + 1)), Sa.hasOwnProperty(
        e) ? {
        space: Sa[e],
        local: n
      } : n
    ...
    if (arguments.length < 2) {
      if ("string" == typeof n) {
        var e = this.node();
        return n = ua.ns.qualify(n), n.local ? e.getAttributeNS(n.space, n.local) :
          e.getAttribute(n)
      }
  ...
  wa.classed = function (n, t) {
      ...
      if ("string" == typeof n) {
        ...
        if (t = e.classList) {
          ...
          for (t = e.getAttribute("class"); ++i < r;)
            if (!_(n[i]).test(t)) return !1; return !0
      }
    ...
    if (3 > r) {
      ...
      if (2 > r) return oa.getComputedStyle(this.node(), null).getPropertyValue(
        n);
      e = ""
    }
    ...
    function e(e, r) {
      return this.insertBefore(aa.createElementNS(this.namespaceURI, n), t.call(
        this, e, r))
    }

    function r(e, r) {
      return this.insertBefore(aa.createElementNS(n.space, n.local), t.call(
        this, e, r))
    }
    return n = ua.ns.qualify(n), "function" != typeof t && (t = v(t)), this.select(
      n.local ? r : e)
  }, wa.remove = function () {
    ...
    function e(n, e) {
      ...
      if (t) {
        var m, v = new i,
          y = new i,
          M = [];
        for (r = -1; ++r < o;) m = t.call(u = n[r], u.__data__, r), v.has(m) ?
          d[r] = u : v.set(m, u), M.push(m);
        for (r = -1; ++r < s;) m = t.call(e, a = e[r], r), (u = v.get(m)) ? (g[
            r] = u, u.__data__ = a) : y.has(m) || (p[r] = A(a)), y.set(m, a), v
          .remove(m);
        for (r = -1; ++r < o;) v.has(M[r]) && (d[r] = n[r])
      } else {
        for (r = -1; ++r < h;) u = n[r], a = e[r], u ? (u.__data__ = a, g[r] =
          u) : p[r] = A(a);
        for (; s > r; ++r) p[r] = A(e[r]);
        for (; o > r; ++r) d[r] = n[r]
      }
      p.update = g, p.parentNode = g.parentNode = d.parentNode = n.parentNode,
        c.push(p), l.push(g), f.push(d)
    }
    var r, u, a = -1,
      o = this.length;
    if (!arguments.length) {
      for (n = Array(o = (r = this[0]).length); ++a < o;)(u = r[a]) && (n[a] =
        u.__data__);
      return n
    }
    var c = L([]),
    ...
    return arguments.length ? this.property("__data__", n) : this.property(
      "__data__")
    ...
    for (var u = 0, a = this.length; a > u; u++) {
      ...
      for (var o = 0, c = e.length; c > o; o++)(r = e[o]) && n.call(r, r.__data__,
        o) && t.push(r)
    }
    return m(i)
  }, wa.order = function () {
  ...
  var Aa = [];
  ua.selection.enter = L, ua.selection.enter.prototype = Aa, Aa.append = wa.append,
    Aa.insert = wa.insert, Aa.empty = wa.empty, Aa.node = wa.node, Aa.select =
    function (n) {
      for (var t, e, r, i, u, a = [], o = -1, c = this.length; ++o < c;) {
        r = (i = this[o]).update, a.push(t = []), t.parentNode = i.parentNode;
        for (var l = -1, f = i.length; ++l < f;)(u = i[l]) ? (t.push(r[l] = e =
          n.call(i.parentNode, u.__data__, l)), e.__data__ = u.__data__) : t.push(
          null)
      }
      return m(a)
    ...
    for (var u = -1, a = this.length; ++u < a;) {
      r.push(n = []);
      for (var o = this[u], c = -1, l = o.length; ++c < l;)(t = o[c]) && yu(t,
        c, e, i), n.push(t)
    }
    return du(r, e)
  ...
  ua.behavior.zoom = function () {
    function n() {
      this.on("mousedown.zoom", o).on("mousemove.zoom", f).on(Ca + ".zoom", c).on(
        "dblclick.zoom", g).on("touchstart.zoom", p).on("touchmove.zoom", d).on(
        "touchend.zoom", p)
    }
    ...
    function o() {
      ...
      function e() {
        c && l(), f.on("mousemove.zoom", null).on("mouseup.zoom", null), c &&
          ua.event.target === o && s(f, "click.zoom")
      }
      var r = this,
        u = k.of(r, arguments),
        o = ua.event.target,
    ...
    function c() {
      m || (m = t(ua.mouse(this))), r(Math.pow(2, qa() * .002) * S), i(ua.mouse(
        this), m), a(k.of(this, arguments))
    }
    ...
    function d() {
      ...
      if (u = n[1]) {
        ...
        t = [(t[0] + u[0]) / 2, (t[1] + u[1]) / 2], e = [(e[0] + o[0]) / 2, (e[
          1] + o[1]) / 2], r(ua.event.scale * v)
      }
    ...
    return n.translate = function (t) {
      ...
      return arguments.length ? (M = t, y = t.copy(), w = [0, 0], S = 1, n) :
        M
    }, n.y = function (t) {
      return arguments.length ? (b = t, x = t.copy(), w = [0, 0], S = 1, n) :
        b
    }, ua.rebind(n, k, "on")
  };
  var qa, Ta = [0, 1 / 0],
  ...
  F.prototype.toString = function () {
    ...
    return arguments.length === 1 ? n instanceof P ? H(n.h, n.s, n.l) : ut("" +
      n, at, H) : H(+n, +t, +e)
  };
  var za = P.prototype = new F;
  za.brighter = function (n) {
    return n = Math.pow(.7, arguments.length ? n : 1), H(this.h, this.s, this.l /
      n)
  }, za.darker = function (n) {
    return n = Math.pow(.7, arguments.length ? n : 1), H(this.h, this.s, n *
      this.l)
  }, za.rgb = function () {
  ...
  ua.hcl = function (n, t, e) {
    return arguments.length === 1 ? n instanceof B ? Z(n.h, n.c, n.l) : n instanceof G ?
      W(n.l, n.a, n.b) : W((n = ot((n = ua.rgb(n)).r, n.g, n.b)).l, n.a, n.b) :
      Z(+n, +t, +e)
  };
  var Ha = B.prototype = new F;
  Ha.brighter = function (n) {
    return Z(this.h, this.c, Math.min(100, this.l + Pa * (arguments.length ? n :
      1)))
  }, Ha.darker = function (n) {
    return Z(this.h, this.c, Math.max(0, this.l - Pa * (arguments.length ? n :
      1)))
  }, Ha.rgb = function () {
    return $(this.h, this.c, this.l).rgb()
  }, ua.lab = function (n, t, e) {
    return arguments.length === 1 ? n instanceof G ? J(n.l, n.a, n.b) : n instanceof B ?
      $(n.l, n.c, n.h) : ot((n = ua.rgb(n)).r, n.g, n.b) : J(+n, +t, +e)
  };
  var Pa = 18,
    Ra = .95047,
    Oa = 1,
  ...
  Ua.brighter = function (n) {
    return J(Math.min(100, this.l + Pa * (arguments.length ? n : 1)), this.a,
      this.b)
  }, Ua.darker = function (n) {
    return J(Math.max(0, this.l - Pa * (arguments.length ? n : 1)), this.a,
      this.b)
  }, Ua.rgb = function () {
    return K(this.l, this.a, this.b)
  }, ua.rgb = function (n, t, e) {
    return arguments.length === 1 ? n instanceof rt ? et(n.r, n.g, n.b) : ut("" +
      n, et, R) : et(~~n, ~~t, ~~e)
  };
  ...
  Ia.brighter = function (n) {
    ...
    var t = this.r,
      ...
      r = this.b,
      i = 30;
    return t || e || r ? (t && i > t && (t = i), e && i > e && (e = i), r && i >
      r && (r = i), et(Math.min(255, Math.floor(t / n)), Math.min(255, Math.floor(
        e / n)), Math.min(255, Math.floor(r / n)))) : et(i, i, i)
  }, Ia.darker = function (n) {
    return n = Math.pow(.7, arguments.length ? n : 1), et(Math.floor(n * this.r),
      Math.floor(n * this.g), Math.floor(n * this.b))
  }, Ia.hsl = function () {
  ...
  Va.forEach(function (n, t) {
    ...
    function r() {
      var n = c.status;
      !n && c.responseText || n >= 200 && 300 > n || 304 === n ? u.load.call(i,
        o.call(i, c)) : u.error.call(i, c)
    }
    var i = {},
      u = ua.dispatch("progress", "load", "error"),
      a = {},
      o = st,
      c = new(oa.XDomainRequest && /^(http(s)?:)?\/\//.test(n) ? XDomainRequest :
        XMLHttpRequest);
    return "onload" in c ? c.onload = c.onerror = r : c.onreadystatechange =
      function () {
        c.readyState > 3 && r()
        ...
        return n = (n + "").toLowerCase(), arguments.length < 2 ? a[n] : (null ==
          t ? delete a[n] : a[n] = t + "", i)
        ...
        if (arguments.length === 2 && "function" == typeof r && (u = r, r =
          null), c.open(e, n, !0), null == t || "accept" in a || (a.accept =
          t + ",*/*"), c.setRequestHeader)
          for (var o in a) c.setRequestHeader(o, a[o]);
        return null != t && c.overrideMimeType && c.overrideMimeType(t), null !=
          u && i.on("error", u).on("load", function (n) {
            u(null, n)
          }), c.send(null == r ? null : r), i
      }, i.abort = function () {
        return c.abort(), i
      }, ua.rebind(i, u, "on"), arguments.length === 2 && "function" == typeof t &&
      (e = t, t = null), null == e ? i : i.get(ht(e))
  ...
  ua.timer = function (n, t, e) {
    ...
    for (var n, t = Date.now(), e = Ja; e;) n = t - e.then, e.delay || (e.flush =
      e.callback(n)), e = e.next;
    dt()
  };
  var Ga = oa.requestAnimationFrame || oa.webkitRequestAnimationFrame || oa.mozRequestAnimationFrame ||
    oa.oRequestAnimationFrame || oa.msRequestAnimationFrame || function (n) {
      setTimeout(n, 17)
    },
    Ka = ".",
    Wa = ",",
    Qa = [3, 3],
    no = ["y", "z", "a", "f", "p", "n", "µ", "m", "", "k", "M", "G", "T", "P",
      "E", "Z", "Y"
    ].map(mt);
  ua.formatPrefix = function (n, t) {
    var e = 0;
    return n && (0 > n && (n *= -1), t && (n = ua.round(n, vt(n, t))), e = 1 +
      Math.floor(1e-12 + Math.log(n) / Math.LN10), e = Math.max(-24, Math.min(
        24, Math.floor((0 >= e ? e + 1 : e - 1) / 3) * 3))), no[8 + e / 3]
    ...
    var t = to.exec(n),
      ...
      h = "",
      g = !1;
    switch (l && (l = +l.substring(1)), (a || "0" === e && "=" === r) && (a = e =
      "0", r = "=", c && (o -= Math.floor((o - 1) / 4))), f) {
    case "n":
      c = !0, f = "g";
      break;
    case "%":
    ...
    "#" === u && (u = ""), "r" != f || l || (f = "g"), null != l && ("g" == f ?
      l = Math.max(1, Math.min(21, l)) : ("e" == f || "f" == f) && (l = Math.max(
        0, Math.min(20, l)))), f = eo.get(f) || yt;
    var p = a && c;
    return function (n) {
      if (g && n % 1) return "";
      ...
      return p && (n = ro(v + n)), Ka && n.replace(".", Ka), t += u, ("<" ===
        r ? t + n + v : ">" === r ? v + t + n : "^" === r ? v.substring(0,
          m >>= 1) + t + n + v.substring(m) : t + (p ? n : v + n)) + h
    }
  };
  var to =
    /(?:([^{])?([<>=^]))?([+\- ])?(#)?(0)?(\d+)?(,)?(\.-?\d+)?([a-z%])?/i,
    eo = ua.map({
      ...
      r: function (n, t) {
        return (n = ua.round(n, vt(n, t))).toFixed(Math.max(0, Math.min(20,
          vt(n * (1 + 1e-15), t))))
      }
    }),
    ro = st;
  if (Qa) {
    var io = Qa.length;
    ro = function (n) {
      for (var t = n.lastIndexOf("."), e = t >= 0 ? "." + n.substring(t + 1) :
        (t = n.length, ""), r = [], i = 0, u = Qa[0]; t > 0 && u > 0;) r.push(n
        .substring(t -= u, t + u)), u = Qa[i = (i + 1) % io];
  ...
  var uo = {
    ...
    ao = {
      ...
      MultiPoint: function (n, t) {
        for (var e, r = n.coordinates, i = -1, u = r.length; ++i < u;) e = r[i],
          t.point(e[0], e[1])
      },
      ...
      MultiLineString: function (n, t) {
        for (var e = n.coordinates, r = -1, i = e.length; ++r < i;) xt(e[r], t,
          0)
      },
  ...
  ua.geo.bounds = function () {
    ...
    function t(t, e) {
      ...
      if (v) {
        ...
        m ? p > t ? o(f, t) > o(f, h) && (h = t) : o(t, h) > o(f, h) && (f = t) :
          h >= f ? (f > t && (f = t), t > h && (h = t)) : t > p ? o(f, t) > o(f,
            h) && (h = t) : o(t, h) > o(f, h) && (f = t)
      } else n(t, e);
      v = r, p = t
    }
    ...
    function a() {
      i(d, m), lo.lineEnd(), Math.abs(y) > ja && (f = -(h = 180)), x[0] = f, x[
        1] = h, v = null
    }
    ...
    var f, s, h, g, p, d, m, v, y, M, x, b = {
      ...
      polygonEnd: function () {
        lo.polygonEnd(), b.point = n, b.lineStart = e, b.lineEnd = r, 0 > co ?
          (f = -(h = 180), s = -(g = 90)) : y > ja ? g = 90 : -ja > y && (s = -
          90), x[0] = f, x[1] = h
      }
    };
    return function (n) {
      g = h = -(f = s = 1 / 0), M = [], ua.geo.stream(n, b), M.sort(c);
      for (var t, e = 1, r = M.length, i = M[0], u = [i]; r > e; ++e) t = M[e],
        l(t[0], i) || l(t[1], i) ? (o(i[0], t[1]) > o(i[0], i[1]) && (i[1] =
          t[1]), o(t[0], i[1]) > o(i[0], i[1]) && (i[0] = t[0])) : u.push(i =
          t);
      for (var a, t, p = -1 / 0, r = u.length - 1, e = 0, i = u[r]; r >= e; i =
        t, ++e) t = u[e], (a = o(i[1], t[0])) > p && (p = a, f = t[0], h = i[
        1]);
      return M = x = null, [
        [f, s],
        [h, g]
    ...
    var t;
    return so && Math.abs(t = Math.sqrt(ho * ho + go * go + po * po)) > ja ? [
      Math.atan2(go, ho) * Fa, Math.asin(Math.max(-1, Math.min(1, po / t))) *
      Fa
    ] : void 0
  };
  var fo, so, ho, go, po, mo = {
    ...
    vo = Pt(Lt, It, Xt),
    yo = 1e9;
  ua.geo.projection = Kt, ua.geo.projectionMutator = Wt, (ua.geo.equirectangular =
    function () {
      return Kt(ne)
    ...
    return n = te(n[0] % 360 * La, n[1] * La, n.length > 2 ? n[2] * La : 0), t.invert =
      function (t) {
    ...
    var e, r = (t[0] - n[0]) * La,
      ...
      f = Math.sin(u),
      s = Math.cos(u);
    return Math.atan2(Math.sqrt((e = s * a) * e + (e = l * f - c * s * o) * e),
      c * f + l * s * o)
    ...
    function t() {
      return ua.range(Math.ceil(u / m) * m, i, m).map(h).concat(ua.range(Math.ceil(
        l / v) * v, c, v).map(g)).concat(ua.range(Math.ceil(r / p) * p, e, p)
        .filter(function (n) {
          return Math.abs(n % m) > ja
        }).map(f)).concat(ua.range(Math.ceil(o / d) * d, a, d).filter(
        function (n) {
    ...
    return n.lines = function () {
      ...
      return {
        type: "Polygon",
        coordinates: [h(u).concat(g(c).slice(1), h(i).reverse().slice(1), g(l)
          .reverse().slice(1))]
      }
    }, n.extent = function (t) {
      return arguments.length ? n.majorExtent(t).minorExtent(t) : n.minorExtent()
    }, n.majorExtent = function (t) {
      return arguments.length ? (u = +t[0][0], i = +t[1][0], l = +t[0][1], c = +
        t[1][1], u > i && (t = u, u = i, i = t), l > c && (t = l, l = c, c =
          t), n.precision(y)) : [
        [u, l],
        [i, c]
      ]
    }, n.minorExtent = function (t) {
      return arguments.length ? (r = +t[0][0], e = +t[1][0], o = +t[0][1], a = +
        t[1][1], r > e && (t = r, r = e, e = t), o > a && (t = o, o = a, a =
          t), n.precision(y)) : [
        [r, o],
        [e, a]
      ]
      ...
      return arguments.length ? (y = +t, f = oe(o, a, 90), s = ce(r, e, y), h =
        oe(l, c, 90), g = ce(u, i, y), n) : y
    }, n.majorExtent([
      [-180, -90 + ja],
      [180, 90 - ja]
    ]).minorExtent([
    ...
    function n() {
      return {
        type: "LineString",
        coordinates: [t || r.apply(this, arguments), e || i.apply(this,
          arguments)]
      }
    }
    var t, e, r = le,
    ...
    return n.distance = function () {
      return ua.geo.distance(t || r.apply(this, arguments), e || i.apply(this,
        arguments))
    }, n.source = function (e) {
      return arguments.length ? (r = e, t = "function" == typeof e ? null : e,
        n) : r
    }, n.target = function (t) {
      return arguments.length ? (i = t, e = "function" == typeof t ? null : t,
        n) : i
  ...
  (ua.geo.conicEqualArea = function () {
    ...
    return ua.geo.conicEqualArea().rotate([96, 0]).center([-.6, 38.7]).parallels(
    ...
    var t, e, r, i, u = ua.geo.albers(),
      a = ua.geo.conicEqualArea().rotate([154, 0]).center([-2, 58.5]).parallels(
        [55, 65]),
      o = ua.geo.conicEqualArea().rotate([157, 0]).center([-3, 19.9]).parallels(
        [8, 18]),
      c = {
        point: function (n, e) {
          t = [n, e]
    ...
    return n.invert = function (n) {
      var t = u.scale(),
        ...
        r = (n[0] - e[0]) / t,
        i = (n[1] - e[1]) / t;
      return (i >= .12 && .234 > i && r >= -.425 && -.214 > r ? a : i >= .166 &&
        .234 > i && r >= -.214 && -.115 > r ? o : u).invert(n)
    }, n.stream = function (n) {
      var t = u.stream(n),
        e = a.stream(n),
        r = o.stream(n);
      ...
      return arguments.length ? (u.precision(t), a.precision(t), o.precision(
        t), n) : u.precision()
    }, n.scale = function (t) {
      return arguments.length ? (u.scale(t), a.scale(.35 * t), o.scale(t), n.translate(
        u.translate())) : u.scale()
  ...
  ua.geo.path = function () {
    function n(n) {
      return n && ua.geo.stream(n, r(i.pointRadius("function" == typeof u ? +u.apply(
        this, arguments) : u))), i.result()
    }
    var t, e, r, i, u = 4.5;
    return n.area = function (n) {
      return bo = 0, ua.geo.stream(n, r(Ao)), bo
    }, n.centroid = function (n) {
      return fo = ho = go = po = 0, ua.geo.stream(n, r(qo)), po ? [ho / po,
        go / po
      ] : void 0
    }, n.bounds = function (n) {
      ...
      return arguments.length ? (i = (e = t) == null ? new ve : new we(t), n) :
        e
  ...
  ua.geom.hull = function (n) {
    function t(n) {
      ...
      if (d === ze && r === De) t = n;
        ...
        for (u = 0, t = []; v > u; ++u) t.push([+d.call(this, i = n[u], u), +m.call(
          this, i, u)]);
      for (u = 1; v > u; ++u)(t[u][1] < t[b][1] || t[u][1] == t[b][1] && t[u][0] <
        t[b][0]) && (b = u);
      for (u = 0; v > u; ++u) u !== b && (c = t[u][1] - t[b][1], o = t[u][0] -
        t[b][0], M.push({
      ...
      for (M.sort(function (n, t) {
        ...
        if (a = M[u].index, g == M[u].angle) {
          if (o = t[h][0] - t[b][0], c = t[h][1] - t[b][1], l = t[a][0] - t[b][
            0
          ], f = t[a][1] - t[b][1], o * o + c * c >= l * l + f * f) {
            M[u].index = -1;
            continue
          }
          M[s].index = -1
      ...
      for (x.push(b), u = 0, a = 0; 2 > u; ++a) M[a].index > -1 && (x.push(M[a]
        .index), u++);
    ...
    return n.area = function () {
      for (var t = 0, e = n.length, r = n[e - 1][1] * n[0][0] - n[e - 1][0] *
        n[0][1]; ++t < e;) r += n[t - 1][1] * n[t][0] - n[t - 1][0] * n[t][1];
      return .5 * r
      ...
      var e, r, i = -1,
        ...
        o = 0,
        c = n[u - 1];
      for (arguments.length || (t = -1 / (6 * n.area())); ++i < u;) e = c, c =
        n[i], r = e[0] * c[1] - c[0] * e[1], a += (e[0] + c[0]) * r, o += (e[
          1] + c[1]) * r;
      return [a * t, o * t]
    }, n.clip = function (t) {
      for (var e, r, i, u, a, o, c = -1, l = n.length, f = n[l - 1]; ++c < l;) {
        for (e = t.slice(), t.length = 0, u = n[c], a = e[(i = e.length) - 1],
          r = -1; ++r < i;) o = e[r], nr(o, f, u) ? (nr(a, f, u) || t.push(tr(
            a, o, f, u)), t.push(o)) : nr(a, f, u) && t.push(tr(a, o, f, u)),
          a = o;
        f = u
      }
      return t
    ...
    return er(n, function (e) {
      ...
      for (var o = 0, c = t.length - 1; c > o; o++) e.push([i, t[o], t[o +
        1]])
    }), e
    ...
    function t(n) {
      ...
      if (c === ze && l === De) t = n;
        ...
        for (t = [], a = 0; f > a; ++a) t.push([+c.call(this, r = n[a], a), +l.call(
          this, r, a)]); if (er(t, function (n) {
        var t, e, r, i, u, a;
        n.a === 1 && n.b >= 0 ? (t = n.ep.r, e = n.ep.l) : (t = n.ep.l, e =
          n.ep.r), n.a === 1 ? (u = t ? t.y : -s, r = n.c - n.b * u, a = e ?
          e.y : s, i = n.c - n.b * a) : (r = t ? t.x : -s, u = n.c - n.a *
          r, i = e ? e.x : s, a = n.c - n.a * i);
        var c = [r, u],
          l = [i, a];
        ...
        if (!(r > 2)) {
          ...
          if (Math.abs(d) < ja) {
            ...
            var m = (l - o) * (g - f) > (h - l) * (f - c) ? s : -s,
              y = Math.abs(d) - p;
            Math.abs(y) < ja ? n.push([0 > d ? m : -m, m]) : (y > 0 && (m *=
              -1), n.push([-s, m], [s, m]))
          }
        }
      }), e)
    ...
    return arguments.length ? t(n) : (t.x = function (n) {
      ...
      if (c === ze && l === De) t = n;
        ...
        for (r = 0; f > r; ++r) t.push([+c.call(this, e = n[r], r), +l.call(
          this, e, r)]);
      ...
      var t, e, r, a, o, c = ft(i),
        l = ft(u);
      for (a = 0, t = [], o = n.length; o > a; ++a) e = [+c.call(this, r =
        n[a], a), +l.call(this, r, a)], e.data = r, t.push(e);
  ...
  ua.geom.quadtree = function (n, t, e, r, i) {
    function u(n) {
        ...
        if (!isNaN(e) && !isNaN(r))
          if (n.leaf) {
            var c = n.x,
              f = n.y;
            if (null != c)
              if (Math.abs(c - e) + Math.abs(f - r) < .01) l(n, t, e, r, i, u,
                a, o);
              else {
                var s = n.point;
                n.x = n.y = n.point = null, l(n, s, c, f, i, u, a, o), l(n, t,
                  e, r, i, u, a, o)
      ...
      function l(n, t, e, r, i, a, o, c) {
        var l = .5 * (i + o),
          ...
          h = r >= f,
          g = (h << 1) + s;
        n.leaf = !1, n = n.nodes[g] || (n.nodes[g] = ur()), s ? i = l : o = l,
          h ? a = f : c = f, u(n, t, e, r, i, a, o, c)
      }
      var f, s, h, g, p, d, m, v, y, M = ft(o),
        x = ft(c);
      if (null != t) d = t, m = e, v = r, y = i;
      else if (v = y = -(d = m = 1 / 0), s = [], h = [], p = n.length, a)
        for (g = 0; p > g; ++g) f = n[g], f.x < d && (d = f.x), f.y < m && (m =
          f.y), f.x > v && (v = f.x), f.y > y && (y = f.y), s.push(f.x), h.push(
          f.y);
      else
        for (g = 0; p > g; ++g) {
          var b = +M(f = n[g], g),
            _ = +x(f, g);
          d > b && (d = b), m > _ && (m = _), b > v && (v = b), _ > y && (y = _),
            s.push(b), h.push(_)
        }
      var w = v - d,
        S = y - m;
    ...
    var a, o = ze,
      c = De;
    return (a = arguments.length) ? (o = rr, c = ir, 3 === a && (i = e, r = t,
      e = t = 0), u(n)) : (u.x = function (n) {
      return arguments.length ? (o = n, u) : o
    }, u.y = function (n) {
      return arguments.length ? (c = n, u) : c
    }, u.size = function (n) {
      return arguments.length ? (null == n ? t = e = r = i = null : (t = e =
        0, r = +n[0], i = +n[1]), u) : null == t ? null : [r, i]
    }, u)
  ...
  ua.interpolateNumber = hr, ua.interpolateTransform = gr, ua.interpolateObject =
    pr, ua.interpolateString = dr;
  var Yo = /[-+]?(?:\d+\.?\d*|\.?\d+)(?:[eE][-+]?\d+)?/g;
  ua.interpolate = mr, ua.interpolators = [
    function (n, t) {
      var e = typeof t;
      return ("string" === e ? Va.has(t) || /^(#|rgb\(|hsl\()/.test(t) ? or :
        dr : t instanceof F ? or : "object" === e ? Array.isArray(t) ? yr :
        pr : hr)(n, t)
    }
  ...
  ua.ease = function (n) {
    ...
    return e = Io.get(e) || Uo, r = Vo.get(r) || st, Mr(r(e.apply(null, Array.prototype
      .slice.call(arguments, 1))))
  }, ua.interpolateHcl = zr, ua.interpolateHsl = Dr, ua.interpolateLab = jr, ua
    .interpolateRound = Lr, ua.layout = {}, ua.layout.bundle = function () {
      return function (n) {
    ...
    function t() {
      e.sort(function (n, t) {
        return c((n.source.value + n.target.value) / 2, (t.source.value + t.target
          .value) / 2)
      })
    }
    var e, r, i, u, a, o, c, l = {},
    ...
    return l.matrix = function (n) {
      return arguments.length ? (u = (i = n) && i.length, e = r = null, l) :
        i
    ...
    return o.tick = function () {
      ...
      var t, e, o, s, h, d, y, M, x, b = m.length,
        _ = v.length;
      for (e = 0; _ > e; ++e) o = v[e], s = o.source, h = o.target, M = h.x -
        s.x, x = h.y - s.y, (d = M * M + x * x) && (d = r * u[e] * ((d = Math
            .sqrt(d)) - i[e]) / d, M *= d, x *= d, h.x -= M * (y = s.weight /
            (h.weight + s.weight)), h.y -= x * y, s.x += M * (y = 1 - y), s.y +=
          x * y);
      if ((y = r * p) && (M = l[0] / 2, x = l[1] / 2, e = -1, y))
        for (; ++e < b;) o = m[e], o.x += (M - o.x) * y, o.y += (x - o.y) * y;
      if (g)
        for (Xr(t = ua.geom.quadtree(m), r, a), e = -1; ++e < b;)(o = m[e]).fixed ||
          t.visit(n(o));
      for (e = -1; ++e < b;) o = m[e], o.fixed ? (o.x = o.px, o.y = o.py) : (
        o.x -= (o.px - (o.px = o.x)) * f, o.y -= (o.py - (o.py = o.y)) * f);
      c.tick({
        type: "tick",
        alpha: r
      })
      ...
      for (e = 0; d > e; ++e) f = v[e], typeof f.source == "number" && (f.source =
          m[f.source]), typeof f.target == "number" && (f.target = m[f.target]), ++
        f.source.weight, ++f.target.weight;
      for (e = 0; p > e; ++e) f = m[e], isNaN(f.x) && (f.x = n("x", y)),
        isNaN(f.y) && (f.y = n("y", M)), isNaN(f.px) && (f.px = f.x), isNaN(f
          .py) && (f.py = f.y);
      ...
      return e || (e = ua.behavior.drag().origin(st).on("dragstart.force", Yr)
        .on("drag.force", t).on("dragend.force", Ur)), arguments.length ? (
        this.on("mouseover.force", Ir).on("mouseout.force", Vr).call(e),
        void 0) : e
    }, ua.rebind(o, c, "on")
  };
  var Xo = 20,
  ...
  ua.layout.hierarchy = function () {
    ...
    function n(t, e, r, i) {
      ...
      if (t.x = e, t.y = t.depth * i, t.dx = r, t.dy = i, u && (a = u.length)) {
        var a, o, c, l = -1;
        for (r = t.value ? r / t.value : 0; ++l < a;) n(o = u[l], e, c = o.value *
          r, i), e += c
      }
    }
    ...
    function n(u) {
      var a = u.map(function (e, r) {
        ...
        c = (("function" == typeof i ? i.apply(this, arguments) : i) - o) / ua.sum(
          a),
        l = ua.range(u.length);
  ...
  ua.layout.stack = function () {
    function n(o, c) {
      ...
      var h, g, p, d = r.call(n, f, c),
        ...
        v = l[0].length;
      for (g = 0; v > g; ++g)
        for (i.call(n, l[0][g], p = d[g], f[0][g][1]), h = 1; m > h; ++h) i.call(
          n, l[h][g], p += f[h - 1][g][1], f[h][g][1]);
      return o
    }
    var t = st,
      e = ni,
    ...
    return n.values = function (e) {
      ...
      return arguments.length ? (e = "function" == typeof t ? t : $o.get(t) ||
        ni, n) : e
    }, n.offset = function (t) {
      return arguments.length ? (r = "function" == typeof t ? t : Jo.get(t) ||
        ti, n) : r
    }, n.x = function (t) {
  ...
  var $o = ua.map({
      "inside-out": function (n) {
        var t, e, r = n.length,
          ...
          l = [],
          f = [];
        for (t = 0; r > t; ++t) e = a[t], c > o ? (o += u[e], l.push(e)) : (c +=
          u[e], f.push(e));
  ...
  ua.layout.histogram = function () {
    function n(n, u) {
      for (var a, o, c = [], l = n.map(e, this), f = r.call(this, l, u), s = i.call(
          this, f, l, u), u = -1, h = l.length, g = s.length - 1, p = t ? 1 :
        1 / h; ++u < g;) a = c[u] = [], a.dx = s[u + 1] - (a.x = s[u]), a.y = 0;
      if (g > 0)
        for (u = -1; ++u < h;) o = l[u], o >= f[0] && o <= f[1] && (a = c[ua.bisect(
          s, o, 1, g) - 1], a.y += p, a.push(n[u]));
      return c
    }
    var t = !0,
      e = Number,
    ...
    function n(n, i) {
      function u(n, t) {
        var r = n.children,
          i = n._tree;
        if (r && (a = r.length)) {
          for (var a, c, l, f = r[0], s = f, h = -1; ++h < a;) l = r[h], u(l, c),
            s = o(l, c, s), c = l;
          mi(n);
          var g = .5 * (f._tree.prelim + l._tree.prelim);
          t ? (i.prelim = t._tree.prelim + e(n, t), i.mod = i.prelim - g) : i.prelim =
            g
      ...
      function o(n, t, r) {
        if (t) {
          for (var i, u = n, a = n, o = t, c = n.parent.children[0], l = u._tree
              .mod, f = a._tree.mod, s = o._tree.mod, h = c._tree.mod; o = fi(o),
            u = li(u), o && u;) c = li(c), a = fi(a), a._tree.ancestor = n, i =
            o._tree.prelim + s - u._tree.prelim - l + e(o, u), i > 0 && (vi(yi(
              o, n, r), n, i), l += i, f += i), s += o._tree.mod, l += u._tree.mod,
            h += c._tree.mod, f += a._tree.mod;
          o && !fi(a) && (a._tree.thread = o, a._tree.mod += s - f), u && !li(c) &&
      ...
      return di(l, function (n) {
        n.x = (n.x - g) / (p - g) * r[0], n.y = n.depth / d * r[1], delete n
          ._tree
      }), c
    }
    ...
    function n(n, i) {
      ...
      di(o, function (n) {
        var t = n.children;
        t && t.length ? (n.x = qi(t), n.y = Ni(t)) : (n.x = u ? c += e(n, u) :
          0, n.y = 0, u = n)
      });
      var l = Ti(o),
        f = Ci(o),
      ...
      return di(o, function (n) {
        n.x = (n.x - s) / (h - s) * r[0], n.y = (1 - (o.y ? n.y / o.y : 1)) *
          r[1]
      }), a
    }
    var t = ua.layout.hierarchy().sort(null).value(null),
    ...
    function n(n, t) {
      for (var e, r, i = -1, u = n.length; ++i < u;) r = (e = n[i]).value * (0 >
        t ? 0 : t), e.area = isNaN(r) || 0 >= r ? 0 : r
    }
    ...
    function t(e) {
      ...
      if (u && u.length) {
        var a, o, c, l = s(e),
          ...
          h = u.slice(),
          p = 1 / 0,
          d = "slice" === g ? l.dx : "dice" === g ? l.dy : "slice-dice" === g ?
          e.depth & 1 ? l.dy : l.dx : Math.min(l.dx, l.dy);
        for (n(h, l.dx * l.dy / e.value), f.area = 0;
          (c = h.length) > 0;) f.push(a = h[c - 1]), f.area += a.area,
          "squarify" !== g || (o = r(f, d)) <= p ? (h.pop(), p = o) : (f.area -=
            f.pop().area, i(f, d, l, !1), d = Math.min(l.dx, l.dy), f.length =
            f.area = 0, p = 1 / 0);
    ...
    function e(t) {
      ...
      if (r && r.length) {
        ...
        for (n(o, a.dx * a.dy / t.value), c.area = 0; u = o.pop();) c.push(u),
          c.area += u.area, u.z != null && (i(c, u.z ? a.dx : a.dy, a, !o.length),
            c.length = c.area = 0);
        r.forEach(e)
      }
    }
    ...
    function r(n, t) {
      ...
      return r *= r, t *= t, r ? Math.max(t * i * p / r, r / (t * u * p)) : 1 /
        0
    }
    ...
    function i(n, t, e, r) {
      var i, u = -1,
        ...
        f = t ? c(n.area / t) : 0;
      if (t == e.dx) {
        for ((r || f > e.dy) && (f = e.dy); ++u < a;) i = n[u], i.x = o, i.y =
          l, i.dy = f, o += i.dx = Math.min(e.x + e.dx - o, f ? c(i.area / f) :
            0);
        i.z = !0, i.dx += e.x + e.dx - o, e.y += f, e.dy -= f
      } else {
        for ((r || f > e.dx) && (f = e.dx); ++u < a;) i = n[u], i.x = o, i.y =
          l, i.dx = f, l += i.dy = Math.min(e.y + e.dy - l, f ? c(i.area / f) :
            0);
    ...
    function u(r) {
      var i = a || o(r),
        u = i[0];
      return u.x = 0, u.y = 0, u.dx = l[0], u.dy = l[1], a && o.revalue(u), n([
        u
      ], u.dx * u.dy / u.value), (a ? e : t)(u), h && (a = i), i
    }
    ...
    return u.size = function (n) {
      ...
      function t(t) {
        ...
        return null == e ? zi(t) : Di(t, "number" == typeof e ? [e, e, e, e] :
          e)
      }
      ...
      var r;
      return s = (f = n) == null ? zi : (r = typeof n) == "function" ? t :
    ...
    normal: function (n, t) {
      ...
      return 2 > e && (t = 1), 1 > e && (n = 0),
        function () {
          var e, r, i;
          do e = Math.random() * 2 - 1, r = Math.random() * 2 - 1, i = e * e +
            r * r; while (!i || i > 1);
  ...
  var Ko = ["#1f77b4", "#ff7f0e", "#2ca02c", "#d62728", "#9467bd", "#8c564b",
      "#e377c2", "#7f7f7f", "#bcbd22", "#17becf"
    ],
    Wo = ["#1f77b4", "#aec7e8", "#ff7f0e", "#ffbb78", "#2ca02c", "#98df8a",
      "#d62728", "#ff9896", "#9467bd", "#c5b0d5", "#8c564b", "#c49c94",
      "#e377c2", "#f7b6d2", "#7f7f7f", "#c7c7c7", "#bcbd22", "#dbdb8d",
      "#17becf", "#9edae5"
    ],
    Qo = ["#393b79", "#5254a3", "#6b6ecf", "#9c9ede", "#637939", "#8ca252",
      "#b5cf6b", "#cedb9c", "#8c6d31", "#bd9e39", "#e7ba52", "#e7cb94",
      "#843c39", "#ad494a", "#d6616b", "#e7969c", "#7b4173", "#a55194",
      "#ce6dbd", "#de9ed6"
    ],
    nc = ["#3182bd", "#6baed6", "#9ecae1", "#c6dbef", "#e6550d", "#fd8d3c",
  ...
  ua.scale.quantile = function () {
    ...
    function n() {
      var n = t.apply(this, arguments),
        ...
        h = Math.cos(o),
        g = Math.sin(o);
      return c >= ec ? n ? "M0," + u + "A" + u + "," + u + " 0 1,1 0," + -u +
        "A" + u + "," + u + " 0 1,1 0," + u + "M0," + n + "A" + n + "," + n +
        " 0 1,0 0," + -n + "A" + n + "," + n + " 0 1,0 0," + n + "Z" : "M0," +
        u + "A" + u + "," + u + " 0 1,1 0," + -u + "A" + u + "," + u +
        " 0 1,1 0," + u + "Z" : n ? "M" + u * f + "," + u * s + "A" + u + "," +
        u + " 0 " + l + ",1 " + u * h + "," + u * g + "L" + n * h + "," + n * g +
        "A" + n + "," + n + " 0 " + l + ",0 " + n * f + "," + n * s + "Z" : "M" +
        u * f + "," + u * s + "A" + u + "," + u + " 0 " + l + ",1 " + u * h +
        "," + u * g + "L0,0" + "Z"
    }
    var t = ru,
      e = iu,
  ...
  ua.svg.line.radial = function () {
    ...
    return n.radius = n.x, delete n.x, n.innerRadius = n.x0, delete n.x0, n.outerRadius =
      n.x1, delete n.x1, n.angle = n.y, delete n.y, n.startAngle = n.y0, delete n
      .y0, n.endAngle = n.y1, delete n.y1, n
  }, ua.svg.chord = function () {
    function n(n, o) {
      var c = t(this, u, n, o),
        l = t(this, a, n, o);
      return "M" + c.p0 + r(c.r, c.p1, c.a1 - c.a0) + (e(c, l) ? i(c.r, c.p1, c
        .r, c.p0) : i(c.r, c.p1, l.r, l.p0) + r(l.r, l.p1, l.a1 - l.a0) + i(
        l.r, l.p1, c.r, c.p0)) + "Z"
    }
  ...
  var rc = ua.map({
    ...
    cross: function (n) {
      ...
      return "M" + -3 * t + "," + -t + "H" + -t + "V" + -3 * t + "H" + t +
        "V" + -t + "H" + 3 * t + "V" + t + "H" + t + "V" + 3 * t + "H" + -t +
        "V" + t + "H" + -3 * t + "Z"
    },
    diamond: function (n) {
      var t = Math.sqrt(n / (2 * ac)),
        e = t * ac;
      return "M0," + -t + "L" + e + ",0" + " 0," + t + " " + -e + ",0" +
        "Z"
    },
    square: function (n) {
      var t = Math.sqrt(n) / 2;
  ...
  oc.call = wa.call, oc.empty = wa.empty, oc.node = wa.node, ua.transition =
    function (n) {
    ...
    for (var a = -1, o = this.length; ++a < o;) {
      u.push(t = []);
      for (var c = this[a], l = -1, f = c.length; ++l < f;)(r = c[l]) && (e = n
        .call(r, r.__data__, l)) ? ("__data__" in r && (e.__data__ = r.__data__),
        yu(e, l, i, r.__transition__[i]), t.push(e)) : t.push(null)
    }
    return du(u, i)
    ...
    for (var c = -1, l = this.length; ++c < l;)
      for (var f = this[c], s = -1, h = f.length; ++s < h;)
        if (r = f[s]) {
          ...
          for (var g = -1, p = e.length; ++g < p;) yu(i = e[g], g, a, u), t.push(
            i)
        }
    return du(o, a)
    ...
    for (var u = 0, a = this.length; a > u; u++) {
      i.push(t = []);
      for (var e = this[u], o = 0, c = e.length; c > o; o++)(r = e[o]) && n.call(
        r, r.__data__, o) && t.push(r)
    }
    return du(i, this.id, this.time).ease(this.ease())
  }, oc.tween = function (n, t) {
    var e = this.id;
    return arguments.length < 2 ? this.node().__transition__[e].tween.get(n) :
      j(this, null == t ? function (t) {
    ...
    function r(r, i) {
      var u = t.call(this, r, i, oa.getComputedStyle(this, null).getPropertyValue(
        n));
      return u && function (t) {
    ...
    var t = this.id;
    return arguments.length < 1 ? this.node().__transition__[t].ease : (
      "function" != typeof n && (n = ua.ease.apply(ua, arguments)), j(this,
        function (e) {
    ...
    for (var n, t, e, r, i = this.id, u = ++cc, a = [], o = 0, c = this.length; c >
      o; o++) {
      a.push(n = []);
      for (var t = this[o], l = 0, f = t.length; f > l; l++)(e = t[l]) && (r =
        Object.create(e.__transition__[i]), r.delay += r.duration, yu(e, l, u,
          r)), n.push(e)
    }
    return du(a, u)
    ...
    function n(n) {
      n.each(function () {
        ...
        switch (r) {
        case "bottom":
          n = Mu, m.attr("y2", u), y.attr("x2", 0).attr("y2", u), N.attr("y2",
            i), C.attr("y", Math.max(i, 0) + o), q.attr("x2", 0).attr("y2", i),
            z.attr("x", 0).attr("y", Math.max(i, 0) + o), T.attr("dy",
              ".71em").style("text-anchor", "middle"), E.attr("d", "M" + w[0] +
              "," + a + "V0H" + w[1] + "V" + a);
          break;
        case "top":
          n = Mu, m.attr("y2", -u), y.attr("x2", 0).attr("y2", -u), N.attr(
            "y2", -i), C.attr("y", -(Math.max(i, 0) + o)), q.attr("x2", 0).attr(
            "y2", -i), z.attr("x", 0).attr("y", -(Math.max(i, 0) + o)), T.attr(
            "dy", "0em").style("text-anchor", "middle"), E.attr("d", "M" + w[
            0] + "," + -a + "V0H" + w[1] + "V" + -a);
          break;
        case "left":
          n = xu, m.attr("x2", -u), y.attr("x2", -u).attr("y2", 0), N.attr(
            "x2", -i), C.attr("x", -(Math.max(i, 0) + o)), q.attr("x2", -i).attr(
            "y2", 0), z.attr("x", -(Math.max(i, 0) + o)).attr("y", 0), T.attr(
            "dy", ".32em").style("text-anchor", "end"), E.attr("d", "M" + -a +
            "," + w[0] + "H0V" + w[1] + "H" + -a);
          break;
        case "right":
          n = xu, m.attr("x2", u), y.attr("x2", u).attr("y2", 0), N.attr("x2",
            i), C.attr("x", Math.max(i, 0) + o), q.attr("x2", i).attr("y2", 0),
            z.attr("x", Math.max(i, 0) + o).attr("y", 0), T.attr("dy",
              ".32em").style("text-anchor", "start"), E.attr("d", "M" + a +
              "," + w[0] + "H0V" + w[1] + "H" + a)
        }
        if (e.ticks) x.call(n, A), _.call(n, k), b.call(n, k), m.call(n, A),
          y.call(n, k), v.call(n, k);
        else {
          var D = k.rangeBand() / 2,
            j = function (n) {
              return k(n) + D
  ...
  ua.svg.brush = function () {
    function n(u) {
      u.each(function () {
        ...
        a.style("pointer-events", "all").on("mousedown.brush", i).on(
          "touchstart.brush", i), l.enter().append("rect").attr("class",
          "background").style("visibility", "hidden").style("cursor",
          "crosshair"), s.enter().append("rect").attr("class", "extent").style(
          "cursor", "move"), h.enter().append("g").attr("class", function (n) {
          return "resize " + n
          ...
          h.style("display", n.empty() ? "none" : null), h.exit().remove(), o &&
          (u = Li(o), l.attr("x", u[0]).attr("width", u[1] - u[0]), e(a)), c &&
          (u = Li(c), l.attr("y", u[0]).attr("height", u[1] - u[0]), r(a)), t(
            a)
      })
    }
    ...
    function e(n) {
      n.select(".extent").attr("x", s[0][0]), n.selectAll(
        ".extent,.n>rect,.s>rect").attr("width", s[1][0] - s[0][0])
    }

    function r(n) {
      n.select(".extent").attr("y", s[0][1]), n.selectAll(
        ".extent,.e>rect,.w>rect").attr("height", s[1][1] - s[0][1])
    }
    ...
    function i() {
      ...
      function f() {
        ua.event.keyCode == 32 && (E || (m = null, k[0] -= s[1][0], k[1] -= s[1]
          [1], E = 2), l())
      }

      function h() {
        ua.event.keyCode == 32 && 2 == E && (k[0] += s[1][0], k[1] += s[1][1],
          E = 0, l())
      }
      ...
      function g() {
        var n = i(),
          u = !1;
        v && (n[0] += v[0], n[1] += v[1]), E || (ua.event.altKey ? (m || (m = [
            (s[0][0] + s[1][0]) / 2, (s[0][1] + s[1][1]) / 2
          ]), k[0] = s[+(n[0] < m[0])][0], k[1] = s[+(n[1] < m[1])][1]) : m =
          null), w && p(n, o, 0) && (e(b), u = !0), S && p(n, c, 1) && (r(b), u = !
          0), u && (t(b), x({
          type: "brush",
          mode: E ? "move" : "resize"
        }))
      ...
      function p(n, t, e) {
        var r, i, a = Li(t),
          ...
          l = k[e],
          f = s[1][e] - s[0][e];
        return E && (o -= l, c -= f + l), r = Math.max(o, Math.min(c, n[e])), E ?
          i = (r += l) + f : (m && (l = Math.max(o, Math.min(c, 2 * m[e] - r))),
            r > l ? (i = r, r = l) : i = l), s[0][e] !== r || s[1][e] !== i ? (
            u = null, s[0][e] = r, s[1][e] = i, !0) : void 0
      }

      function d() {
        g(), b.style("pointer-events", "all").selectAll(".resize").style(
          "display", n.empty() ? "none" : null), ua.select("body").style(
          "cursor", null), A.on("mousemove.brush", null).on("mouseup.brush",
          null).on("touchmove.brush", null).on("touchend.brush", null).on(
          "keydown.brush", null).on("keyup.brush", null), x({
          type: "brushend"
        }), l()
      }
      var m, v, y = this,
        ...
        E = M.classed("extent"),
        k = i(),
        A = ua.select(oa).on("mousemove.brush", g).on("mouseup.brush", d).on(
          "touchmove.brush", g).on("touchend.brush", d).on("keydown.brush", f).on(
          "keyup.brush", h);
      if (E) k[0] = s[0][0] - k[0], k[1] = s[0][1] - k[1];
      else if (_) {
        var N = +/w$/.test(_),
          q = +/^n/.test(_);
        v = [s[1 - N][0] - k[0], s[1 - q][1] - k[1]], k[0] = s[N][0], k[1] = s[
          q][1]
      } else ua.event.altKey && (m = k.slice());
      b.style("pointer-events", "none").selectAll(".resize").style("display",
        null), ua.select("body").style("cursor", M.style("cursor")), x({
        type: "brushstart"
      }), g(), l()
    }
    ...
    return n.x = function (t) {
      ...
      return arguments.length ? (u = [
        [0, 0],
        [0, 0]
      ], o && (e = t[0], r = t[1], c && (e = e[0], r = r[0]), u[0][0] = e,
        u[1][0] = r, o.invert && (e = o(e), r = o(r)), e > r && (l = e, e =
          r, r = l), s[0][0] = 0 | e, s[1][0] = 0 | r), c && (i = t[0], a =
        t[1], o && (i = i[1], a = a[1]), u[0][1] = i, u[1][1] = a, c.invert &&
        (i = c(i), a = c(a)), i > a && (l = i, i = a, a = l), s[0][1] = 0 |
        i, s[1][1] = 0 | a), n) : (t = u || s, o && (e = t[0][0], r = t[1][
          0
        ], u || (e = s[0][0], r = s[1][0], o.invert && (e = o.invert(e),
          r = o.invert(r)), e > r && (l = e, e = r, r = l))), c && (i = t[0]
          [1], a = t[1][1], u || (i = s[0][1], a = s[1][1], c.invert && (i =
            c.invert(i), a = c.invert(a)), i > a && (l = i, i = a, a = l))),
        o && c ? [
          [e, i],
          [r, a]
        ] : o ? [e, r] : c && [i, a])
  ...
  ua.time = {};
  var pc = Date,
    dc = ["Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday",
      "Saturday"
    ];
  _u.prototype = {
    getDate: function () {
  ...
  var mc = Date.prototype,
    ...
    yc = "%m/%d/%Y",
    Mc = "%H:%M:%S",
    xc = ["Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday",
      "Saturday"
    ],
    bc = ["Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"],
    _c = ["January", "February", "March", "April", "May", "June", "July",
      "August", "September", "October", "November", "December"
    ],
    wc = ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct",
      "Nov", "Dec"
    ];
  ...
  }), ua.time.years = ua.time.year.range, ua.time.years.utc = ua.time.year.utc.range,
    ua.time.day = wu(function (n) {
      var t = new pc(1970, 0);
      ...
      return n.getDate() - 1
    }), ua.time.days = ua.time.day.range, ua.time.days.utc = ua.time.day.utc.range,
    ua.time.dayOfYear = function (n) {
      var t = ua.time.year(n);
      return Math.floor((n - t - (n.getTimezoneOffset() - t.getTimezoneOffset()) *
        6e4) / 864e5)
  }, dc.forEach(function (n, t) {
    n = n.toLowerCase(), t = 7 - t;
    var e = ua.time[n] = wu(function (n) {
      return (n = ua.time.day(n)).setDate(n.getDate() - (n.getDay() + t) %
        7), n
    }, function (n, t) {
      n.setDate(n.getDate() + Math.floor(t) * 7)
    }, function (n) {
      var e = ua.time.year(n).getDay();
      return Math.floor((ua.time.dayOfYear(n) + (e + t) % 7) / 7) - (e !==
        t)
    });
    ua.time[n + "s"] = e.range, ua.time[n + "s"].utc = e.utc.range, ua.time[n +
      "OfYear"] = function (n) {
      var e = ua.time.year(n).getDay();
      return Math.floor((ua.time.dayOfYear(n) + (e + t) % 7) / 7)
    }
  }), ua.time.week = ua.time.sunday, ua.time.weeks = ua.time.sunday.range, ua.time
    .weeks.utc = ua.time.sunday.utc.range, ua.time.weekOfYear = ua.time.sundayOfYear,
    ua.time.format = function (n) {
      function t(t) {
        for (var r, i, u, a = [], o = -1, c = 0; ++o < e;) n.charCodeAt(o) ===
          37 && (a.push(n.substring(c, o)), (i = Tc[r = n.charAt(++o)]) != null &&
            (r = n.charAt(++o)), (u = Cc[r]) && (r = u(t, null == i ? "e" === r ?
              " " : "0" : i)), a.push(r), c = o + 1);
      ...
      return t.parse = function (t) {
        ...
        var i = new pc;
        return i.setFullYear(e.y, e.m, e.d), i.setHours(e.H, e.M, e.S, e.L),
          i
      }, t.toString = function () {
        return n
      }, t
  ...
  ua.time.format.iso = Date.prototype.toISOString && +new Date(
    "2000-01-01T00:00:00.000Z") ? Bu : Lc, Bu.parse = function (n) {
    var t = new Date(n);
    ...
    return n.getSeconds()
  }), ua.time.seconds = ua.time.second.range, ua.time.seconds.utc = ua.time.second
    .utc.range, ua.time.minute = wu(function (n) {
      return new pc(Math.floor(n / 6e4) * 6e4)
    }, function (n, t) {
      n.setTime(n.getTime() + Math.floor(t) * 6e4)
    }, function (n) {
      return n.getMinutes()
    }), ua.time.minutes = ua.time.minute.range, ua.time.minutes.utc = ua.time.minute
    .utc.range, ua.time.hour = wu(function (n) {
      ...
      return n.getHours()
    }), ua.time.hours = ua.time.hour.range, ua.time.hours.utc = ua.time.hour.utc
    .range, ua.time.month = wu(function (n) {
      return n = ua.time.day(n), n.setDate(1), n
    }, function (n, t) {
      n.setMonth(n.getMonth() + t)
    }, function (n) {
      return n.getMonth()
    }), ua.time.months = ua.time.month.range, ua.time.months.utc = ua.time.month
    .utc.range;
  var Fc = [1e3, 5e3, 15e3, 3e4, 6e4, 3e5, 9e5, 18e5, 36e5, 108e5, 216e5, 432e5,
