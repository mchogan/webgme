...
define(['logManager',
  ...
  BranchStatusWidget.prototype._initializeUI = function () {
    ...
    this._client.addEventListener(this._client.events.BRANCHSTATUS_CHANGED,
  ...
  BranchStatusWidget.prototype._branchInSync = function () {
    ...
    if (this._outOfSync === true) {
      this._popoverBox.show('Branch in sync again...', this._popoverBox.alertLevels
        .SUCCESS, true);
  ...
  BranchStatusWidget.prototype._branchForked = function () {
    ...
    this._popoverBox = this._popoverBox || new PopoverBox(this._ddBranchStatus
      .getEl());
    this._popoverBox.show('Branch out of sync...', this._popoverBox.alertLevels
      .WARNING, false);
  };
