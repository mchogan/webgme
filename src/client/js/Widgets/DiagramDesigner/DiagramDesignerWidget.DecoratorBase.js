...
define(['js/Decorators/WidgetDecoratorBase',
  ...
  _.extend(DiagramDesignerWidgetDecoratorBase.prototype,
    DiagramDesignerWidgetDecoratorBaseConnectionArea.prototype);
  ...
  DiagramDesignerWidgetDecoratorBase.prototype.initializeConnectors =
    function () {
      //find connectors
      this.$sourceConnectors = this.$el.find('.' +
        DiagramDesignerWidgetConstants.CONNECTOR_CLASS);
  ...
  DiagramDesignerWidgetDecoratorBase.prototype.showSourceConnectors =
    function (params) {
  ...
  DiagramDesignerWidgetDecoratorBase.prototype.hideSourceConnectors =
    function () {
  ...
  //            NOTE: if the value is undefined, the connectors for the host item should be highlighted
  //                  if the value is not undefined, the connector for the corresponding subcomponent should be highlighted
  DiagramDesignerWidgetDecoratorBase.prototype.showEndConnectors = function (
    params) {
  ...
  DiagramDesignerWidgetDecoratorBase.prototype.onRenderGetLayoutInfo =
    function () {
  ...
  //NOTE - CAN BE OVERRIDDEN WHEN NEEDED
  DiagramDesignerWidgetDecoratorBase.prototype.onRenderSetLayoutInfo =
    function () {
  ...
  DiagramDesignerWidgetDecoratorBase.prototype.calculateDimension = function () {
    if (this.hostDesignerItem) {
      this.hostDesignerItem.setSize(this.$el.outerWidth(true), this.$el.outerHeight(
        true));
    }
  };
  ...
  //NOTE - SHALL BE OVERRIDDEN WHEN NEEDED
  DiagramDesignerWidgetDecoratorBase.prototype.getConnectionAreas = function (
  ...
  //return TRUE if decorator code handled the event
  //when returned FALSE, DesignerItem's event handler will be executed
  DiagramDesignerWidgetDecoratorBase.prototype.onDoubleClick = function (
    event) {
    return false;
  };
  ...
  DiagramDesignerWidgetDecoratorBase.prototype.updateSubcomponent = function (
    subComponentId) {};

  DiagramDesignerWidgetDecoratorBase.prototype.readOnlyMode = function (
    readOnlyMode) {};
  ...
  DiagramDesignerWidgetDecoratorBase.prototype.getConnectorMetaInfo =
    function (id) {
      return undefined;
  };
  ...
  DiagramDesignerWidgetDecoratorBase.prototype.doSearch = function (
    searchDesc) {
    return false;
  };
  ...
  DiagramDesignerWidgetDecoratorBase.prototype.getDrawnConnectionVisualStyle =
    function (subComponentId) {
      return null;
  };
  ...
  DiagramDesignerWidgetDecoratorBase.prototype.notifyComponentEvent =
    function (componentList) {
      this.logger.warning('notifyComponentEvent not overridden in decorator' +
