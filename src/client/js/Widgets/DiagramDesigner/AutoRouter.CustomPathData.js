...
define(['logManager',
  ...
  AutoRouterCustomPathData.prototype.serialize = function () {
    var outChannel = (this.getVersion() + ',' + this.getAspect() + ',' + this.getEdgeIndex() + ',' + this.getEdgeCount() +
      ',' + this.getType());
  ...
  AutoRouterCustomPathData.prototype.deserialize = function (inChannel) {
    ...
    console.log('\tAsp ' + this.getAspect() + ', Ind ' + this.getEdgeIndex() + ', Cnt ' + this.getEdgeCount() +
      ', Typ ' + this.getType());
    ...
    console.log(', Dir ' + UTILS.isHorizontalOrVertical() + ', x ' + this.getX() + ', y ' + this.getY() + ', num ' +
      numOfExtraLongData);
