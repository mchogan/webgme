...
define([], function () {
  ...
  DiagramDesignerWidgetSubcomponents.prototype.registerSubcomponent =
  ...
  DiagramDesignerWidgetSubcomponents.prototype.unregisterSubcomponent =
  ...
  DiagramDesignerWidgetSubcomponents.prototype.unregisterAllSubcomponents =
    function (objID) {
      var len;
      ...
      if (this._itemSubcomponentsMap[objID]) {
        ...
        while (len--) {
          this.unregisterSubcomponent(objID, this._itemSubcomponentsMap[objID]
            [len]);
        }
