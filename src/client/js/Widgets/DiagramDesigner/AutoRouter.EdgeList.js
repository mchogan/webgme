...
define(['logManager',
  ...
  AutoRouterEdgeList.prototype.dumpEdges = function (msg) {
    ...
    while (edge !== null) {
      console.log('\t' + edge.getStartPoint().x + ', ' + edge.getStartPoint().y + '\t\t' + edge.getEndPoint().x +
        ', ' + edge.getEndPoint().y + '\t\t\t(' + (edge.getEdgeFixed() ? 'FIXED' : 'MOVEABLE') + ')\t\t' + (edge.getBracketClosing() ?
          'Bracket Closing' : (edge.getBracketOpening() ? 'Bracket Opening' : '')));
      edge = edge.getOrderNext();
      total++;
    }
  ...
  AutoRouterEdgeList.prototype.section_HasBlockedEdge = function () {
    ...
    } else //section_ptr2blocked contains a null placeholder
    {
      ...
      } else // case 2
      {
        ...
        while (e && !e.getStartPoint().equals(CONSTANTS.EMPTY_POINT)) {
          ...
          if (o.getSectionX2() + 1 < b1 && (e === null || e.getStartPoint().equals(CONSTANTS.EMPTY_POINT) || o.getSectionX2() +
            1 < e.getSectionX1())) {
    ...
    assert(this.section_blocker.getSectionNext() === null && (this.section_blocker.getSectionDown() === null || this.section_blocker
        .getSectionDown().getStartPoint().equals(CONSTANTS.EMPTY_POINT)),
