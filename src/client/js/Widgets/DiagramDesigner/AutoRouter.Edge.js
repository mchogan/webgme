...
define(['logManager',
  ...
  AutoRouterEdge.prototype.assign = function (otherEdge) {
    ...
    if (otherEdge !== null) {
      ...
      this.setEndPoint(otherEdge.getEndPointPtr(), otherEdge.getEndPointPtr() !==
        null); //Only calculateDirection if this.endpoint is not null
  ...
  AutoRouterEdge.prototype.getStartPointPrev = function () {
    return this.startpoint_prev !== null ? this.startpoint_prev[0] || this.startpoint_prev :
      null;
  };
  ...
  AutoRouterEdge.prototype.getStartPoint = function () {
    return this.startpoint !== null ?
      (this.startpoint instanceof Array ? new ArPoint(this.startpoint[0]) :
        new ArPoint(this.startpoint)) : CONSTANTS.EMPTY_POINT; //returning copy of this.startpoint
  };
  ...
  AutoRouterEdge.prototype.getEndPoint = function () {
    return this.endpoint !== null ? (this.endpoint instanceof Array ? new ArPoint(
      this.endpoint[0]) : new ArPoint(this.endpoint)) : CONSTANTS.EMPTY_POINT;
  };
  ...
  AutoRouterEdge.prototype.setStartAndEndPoint = function (startPoint,
    endPoint) {
  ...
  AutoRouterEdge.prototype.getEndPointNext = function () {
    return this.endpoint_next !== null ? ((this.endpoint_next instanceof Array) ?
        new ArPoint(this.endpoint_next[0]) : new ArPoint(this.endpoint_next)) :
  ...
  AutoRouterEdge.prototype.recalculateDirection = function () {
    ...
    if (this.endpoint instanceof Array) {
      this.edge_direction = UTILS.getDir(this.endpoint[0].minus((this.startpoint instanceof Array ?
        this.startpoint[0] : this.startpoint)));
    } else {
      this.edge_direction = UTILS.getDir(this.endpoint.minus((this.startpoint instanceof Array ?
        this.startpoint[0] : this.startpoint)));
    }
  };
