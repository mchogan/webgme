...
define(['logManager'], function (logManager) {
  ...
  ConnectionRouteManagerBasic.prototype._updateEndpointInfo = function (
    idList) {
    var i = idList.length,
      connId,
  ...
  ConnectionRouteManagerBasic.prototype._getEndpointConnectionAreas =
    function (objId, subCompId, isEnd, connectionMetaInfo) {
      var longid = subCompId ? objId + DESIGNERITEM_SUBCOMPONENT_SEPARATOR +
        subCompId : objId,
        res,
        canvas = this.diagramDesigner,
        j,
  ...
  ConnectionRouteManagerBasic.prototype._updateConnectionCoordinates =
  ...
  ConnectionRouteManagerBasic.prototype._getClosestPoints = function (
