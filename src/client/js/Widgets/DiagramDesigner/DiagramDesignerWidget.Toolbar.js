...
define(['./DiagramDesignerWidget.OperatingModes',
  ...
  DiagramDesignerWidgetToolbar.prototype._initializeToolbar = function () {
    ...
    if (toolbar) {
      ...
      this.toolbarItems.radioButtonGroupRouteManager = toolbar.addRadioButtonGroup(
        function (data) {
      ...
      this.toolbarItems.radioButtonGroupRouteManager.addButton({
        "title": "AutoRouter",
        "icon": btnIconBase.clone().addClass(
          'gme icon-gme_broken-arrow-with-box'),
        "selected": true,
        "data": {
          "type": "basic3"
        }
      ...
      this.toolbarItems.radioButtonGroupOperatingMode = toolbar.addRadioButtonGroup(
        function (data) {
      ...
      this.toolbarItems.radioButtonGroupOperatingMode.addButton({
        ...
        "data": {
          "mode": DiagramDesignerWidgetOperatingModes.prototype.OPERATING_MODES
            .READ_ONLY
        }
      });
      ...
      if (this._lineStyleControls === true) {
        ...
        var createArrowMenuItem = function (arrowType, isEnd) {
          var size = arrowType === DiagramDesignerWidgetConstants.LINE_ARROWS
            .NONE ? "" : "-xwide-xlong",
          ...
          return {
            "title": arrowType,
            "icon": self._createLineStyleMenuItem(null, null, null,
              startArrow, endArrow),
            "data": {
              'endArrow': endArrow,
        ...
        var createPatternMenuItem = function (pattern) {
          return {
            ...
            "icon": self._createLineStyleMenuItem(null, null,
              DiagramDesignerWidgetConstants.LINE_PATTERNS[pattern], null,
              null),
            "data": {
              'pattern': pattern
            },
        ...
        for (it in DiagramDesignerWidgetConstants.LINE_ARROWS) {
          if (DiagramDesignerWidgetConstants.LINE_ARROWS.hasOwnProperty(it)) {
            this.toolbarItems.ddbtnConnectionArrowStart.addButton(
              createArrowMenuItem(DiagramDesignerWidgetConstants.LINE_ARROWS[
                it], false));
        ...
        for (it in DiagramDesignerWidgetConstants.LINE_PATTERNS) {
          if (DiagramDesignerWidgetConstants.LINE_PATTERNS.hasOwnProperty(it)) {
            this.toolbarItems.ddbtnConnectionPattern.addButton(
              createPatternMenuItem(it));
          }
        }
        ...
        this.toolbarItems.ddbtnConnectionLineType.addButton({
          ...
          "clickFn": function ( /*data*/ ) {
            var p = {};
            p[DiagramDesignerWidgetConstants.LINE_TYPE] =
              DiagramDesignerWidgetConstants.LINE_TYPES.NONE;
            self._setConnectionProperty(p);
          }
        });
        ...
        this.toolbarItems.ddbtnConnectionLineType.addButton({
          "title": 'Bezier',
          "icon": self._createLineStyleMenuItem(null, null, null, null,
            null, DiagramDesignerWidgetConstants.LINE_TYPES.BEZIER),
          "clickFn": function ( /*data*/ ) {
            var p = {};
            p[DiagramDesignerWidgetConstants.LINE_TYPE] =
        ...
        var createWidthMenuItem = function (width) {
          return {
            ...
            "icon": self._createLineStyleMenuItem(width, null,
              DiagramDesignerWidgetConstants.LINE_PATTERNS.SOLID, null,
              null),
            "data": {
              'width': width
            },
        ...
        for (it = 1; it < 10; it += 1) {
          this.toolbarItems.ddbtnConnectionLineWidth.addButton(
            createWidthMenuItem(it));
        }
      ...
      this.toolbarItems.cpFillColor = toolbar.addColorPicker({
        ...
        'colorChangedFn': function (color) {
          self.onSelectionFillColorChanged(self.selectionManager.getSelectedElements(),
            color);
        }
      });
      ...
      this.toolbarItems.cpBorderColor = toolbar.addColorPicker({
        ...
        'title': 'Border color',
        'colorChangedFn': function (color) {
          self.onSelectionBorderColorChanged(self.selectionManager.getSelectedElements(),
            color);
        }
      });
      ...
      this.toolbarItems.cpTextColor = toolbar.addColorPicker({
        ...
        'title': 'Text color',
        'colorChangedFn': function (color) {
          self.onSelectionTextColorChanged(self.selectionManager.getSelectedElements(),
            color);
        }
      });
