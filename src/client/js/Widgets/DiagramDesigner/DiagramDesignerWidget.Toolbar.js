  ...
  DiagramDesignerWidgetToolbar.prototype._initializeToolbar = function () {
    ...
    if (toolbar) {
      ...
      this.toolbarItems.radioButtonGroupOperatingMode.addButton({
        ...
        'data': {
          'mode': DiagramDesignerWidgetOperatingModes.prototype.OPERATING_MODES.READ_ONLY
        }
      });
      ...
      this.toolbarItems.radioButtonGroupOperatingMode.addButton({
        ...
        'selected': true,
        'data': {
          'mode': DiagramDesignerWidgetOperatingModes.prototype.OPERATING_MODES.DESIGN
        }
      });
      ...
      this.toolbarItems.radioButtonGroupOperatingMode.addButton({
        ...
        'data': {
          'mode': DiagramDesignerWidgetOperatingModes.prototype.OPERATING_MODES.HIGHLIGHT
        }
      });
      ...
      if (this._lineStyleControls === true) {
        ...
        var createPatternMenuItem = function (pattern) {
          return {
            'title': pattern,
            'icon': self._createLineStyleMenuItem(null, null, DiagramDesignerWidgetConstants.LINE_PATTERNS[pattern],
              null, null),
            'data': {
              'pattern': pattern
            },
        ...
        for (it in DiagramDesignerWidgetConstants.LINE_ARROWS) {
          if (DiagramDesignerWidgetConstants.LINE_ARROWS.hasOwnProperty(it)) {
            this.toolbarItems.ddbtnConnectionArrowStart.addButton(createArrowMenuItem(DiagramDesignerWidgetConstants.LINE_ARROWS[
              it], false));
            this.toolbarItems.ddbtnConnectionArrowEnd.addButton(createArrowMenuItem(DiagramDesignerWidgetConstants.LINE_ARROWS[
              it], true));
          }
        }
        ...
        this.toolbarItems.ddbtnConnectionLineType.addButton({
          'title': 'Bezier',
          'icon': self._createLineStyleMenuItem(null, null, null, null, null, DiagramDesignerWidgetConstants.LINE_TYPES
            .BEZIER),
          'clickFn': function ( /*data*/ ) {
            var p = {};
        ...
        var createWidthMenuItem = function (width) {
          return {
            'title': width,
            'icon': self._createLineStyleMenuItem(width, null, DiagramDesignerWidgetConstants.LINE_PATTERNS.SOLID,
              null, null),
            'data': {
              'width': width
            },
