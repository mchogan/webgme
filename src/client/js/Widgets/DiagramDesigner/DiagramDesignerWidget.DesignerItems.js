...
define(['js/Widgets/DiagramDesigner/DesignerItem'], function (DesignerItem) {
  ...
  DiagramDesignerWidgetDesignerItems.prototype.createDesignerItem = function (objD) {
    ...
    newComponent.__setDecorator(objDescriptor.decorator, objDescriptor.decoratorClass, objDescriptor.control,
      objDescriptor.metaInfo, objDescriptor.preferencesHelper, objDescriptor.aspect, objDescriptor.decoratorParams);
