...
define(['js/Utils/GMEConcepts',
  ...
  _.extend(SetEditorController.prototype,
    DiagramDesignerWidgetMultiTabMemberListControllerBase.prototype);

  SetEditorController.prototype.getOrderedMemberListInfo = function (
  ...
  /**********************************************************/
  SetEditorController.prototype._onBackgroundDroppableAccept = function (
    event, dragInfo) {
    ...
    if (accept === true) {
      ...
      accept = GMEConcepts.canAddToSet(this._memberListContainerID, this._selectedMemberListID,
        gmeIDList);
    }
