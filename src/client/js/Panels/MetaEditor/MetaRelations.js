...
define(['js/Constants',
  ...
  var _createButtonIcon = function (btnSize, connType) {
    ...
    if (connType === _meta_relations.CONTAINMENT ||
      ...
      pathParams[DiagramDesignerWidgetConstants.LINE_START_ARROW] = _convertToButtonLineEndStyle(pathParams[
        DiagramDesignerWidgetConstants.LINE_START_ARROW]);
      pathParams[DiagramDesignerWidgetConstants.LINE_END_ARROW] = _convertToButtonLineEndStyle(pathParams[
    ...
    el.attr({
      'style': 'height: ' + btnSize + 'px; margin-top: 2px; margin-bottom: 2px;'
    });
