...
define(['logManager',
  ...
  var DiagramDesignerWidgetMultiTabMemberListControllerBase,
    ...
    DRAG_PARAMS_MULTI_TAB_MEMBER_LIST_CONTAINER_ID =
    'DRAG_PARAMS_MULTI_TAB_MEMBER_LIST_CONTAINER_ID',
  ...
  DiagramDesignerWidgetMultiTabMemberListControllerBase = function (options) {
    this.logger = logManager.create(options.loggerName ||
    ...
    if (this._client === undefined) {
      this.logger.error(
        "DiagramDesignerWidgetMultiTabMemberListControllerBase's client is not specified..."
      );
      throw (
        "DiagramDesignerWidgetMultiTabMemberListControllerBase can not be created"
      );
    }

    if (this._widget === undefined) {
      this.logger.error(
        "DiagramDesignerWidgetMultiTabMemberListControllerBase's widget is not specified..."
      );
      throw (
        "DiagramDesignerWidgetMultiTabMemberListControllerBase can not be created"
      );
    ...
    this.logger.debug(
      "DiagramDesignerWidgetMultiTabMemberListControllerBase ctor finished");
  };
  ...
  DiagramDesignerWidgetMultiTabMemberListControllerBase.prototype._attachDiagramDesignerWidgetEventHandlers =
    function () {
      ...
      this._widget.onSelectionFillColorChanged = function (selectedElements,
        color) {
        self._onSelectionSetColor(selectedElements, color, REGISTRY_KEYS.COLOR);
      };

      this._widget.onSelectionBorderColorChanged = function (selectedElements,
        color) {
        self._onSelectionSetColor(selectedElements, color, REGISTRY_KEYS.BORDER_COLOR);
      };

      this._widget.onSelectionTextColorChanged = function (selectedElements,
        color) {
      ...
      this._widget.onRegisterSubcomponent = function (objID, sCompID,
        metaInfo) {
  ...
  DiagramDesignerWidgetMultiTabMemberListControllerBase.prototype.selectedObjectChanged =
    function (nodeId) {
      var self = this,
        pattern;
  ...
  DiagramDesignerWidgetMultiTabMemberListControllerBase.prototype._validateNodeId =
    function (nodeId) {
  ...
  DiagramDesignerWidgetMultiTabMemberListControllerBase.prototype._stateActiveObjectChanged =
    function (model, activeObjectId) {
      this.selectedObjectChanged(activeObjectId);
  };

  DiagramDesignerWidgetMultiTabMemberListControllerBase.prototype._attachClientEventListeners =
    function () {
  ...
  DiagramDesignerWidgetMultiTabMemberListControllerBase.prototype._detachClientEventListeners =
    function () {
      WebGMEGlobal.State.off('change:' + CONSTANTS.STATE_ACTIVE_OBJECT, this._stateActiveObjectChanged);
  };

  DiagramDesignerWidgetMultiTabMemberListControllerBase.prototype.onActivate =
    function () {
      this._attachClientEventListeners();
      this._displayToolbarItems();
  };

  DiagramDesignerWidgetMultiTabMemberListControllerBase.prototype.onDeactivate =
    function () {
      this._detachClientEventListeners();
      this._hideToolbarItems();
  };

  DiagramDesignerWidgetMultiTabMemberListControllerBase.prototype._displayToolbarItems =
    function () {
  ...
  DiagramDesignerWidgetMultiTabMemberListControllerBase.prototype._hideToolbarItems =
    function () {
      if (this._toolbarInitialized === true) {
        for (var i = 0; i < this._toolbarItems.length; i++) {
  ...
  DiagramDesignerWidgetMultiTabMemberListControllerBase.prototype._removeToolbarItems =
    function () {
      if (this._toolbarInitialized === true) {
        for (var i = 0; i < this._toolbarItems.length; i++) {
  ...
  DiagramDesignerWidgetMultiTabMemberListControllerBase.prototype._initializeToolbar =
    function () {
      this._toolbarItems = [];
  ...
  DiagramDesignerWidgetMultiTabMemberListControllerBase.prototype.setReadOnly =
    function (isReadOnly) {

  };

  DiagramDesignerWidgetMultiTabMemberListControllerBase.prototype.destroy =
    function () {
      this._detachClientEventListeners();
  ...
  DiagramDesignerWidgetMultiTabMemberListControllerBase.prototype._processMemberListContainer =
    function () {
      ...
      if (memberListContainerObj) {
        ...
        orderedMemberListInfo = this.getOrderedMemberListInfo(
        ...
        if (orderedMemberListInfo.length > 0) {
          ...
          for (i = 0; i < orderedMemberListInfo.length; i += 1) {
            ...
            this._memberListMembers[memberListID] = memberListContainerObj.getMemberIds(
              memberListID);
            ...
            while (j--) {
              ...
              this._memberListMemberCoordinates[memberListID][gmeID] =
                memberListContainerObj.getMemberRegistry(memberListID, gmeID,
          ...
          if (!selectedMemberListTabID) {
            for (selectedMemberListTabID in this._tabIDMemberListID) {
              if (this._tabIDMemberListID.hasOwnProperty(
                selectedMemberListTabID)) {
                break;
              }
            }
  ...
  DiagramDesignerWidgetMultiTabMemberListControllerBase.prototype._updateSelectedMemberListMembersTerritoryPatterns =
    function () {
      var currentlyDisplayedMembers = (this._selectedMemberListMembers || [])
        .slice(0),
        actualMembers = (this._memberListMembers[this._selectedMemberListID] || [])
        .slice(0),
        diff,
        len,
  ...
  DiagramDesignerWidgetMultiTabMemberListControllerBase.prototype.getOrderedMemberListInfo =
    function (memberListContainerObject) {
      ...
      this.logger.warning(
        'DiagramDesignerWidgetMultiTabMemberListControllerBase.getOrderedMemberListInfo(memberListContainerObject) is not overridden for object "' +
        memberListContainerObject + '", returning default...');

      return undefined;
  };

  DiagramDesignerWidgetMultiTabMemberListControllerBase.prototype.getMemberListSetsRegistryKey =
    function () {
      this.logger.warning(
        'DiagramDesignerWidgetMultiTabMemberListControllerBase.getMemberListSetsRegistryKey is not overridden, returning default value...'
      );
      return undefined;
  };

  DiagramDesignerWidgetMultiTabMemberListControllerBase.prototype._onSelectedTabChanged =
    function (tabID) {
      if (this._tabIDMemberListID[tabID] && this._selectedMemberListID !==
        this._tabIDMemberListID[tabID]) {
  ...
  DiagramDesignerWidgetMultiTabMemberListControllerBase.prototype._getDragParams =
    function (selectedElements, event) {
      var oParams = this._oGetDragParams.call(this._widget, selectedElements,
          event),
        params = {
          'positions': {}
        },
  ...
  DiagramDesignerWidgetMultiTabMemberListControllerBase.prototype._getDragItems =
  ...
  DiagramDesignerWidgetMultiTabMemberListControllerBase.prototype._getDragParamsDataID =
    function () {
  ...
  /**********************************************************/
  DiagramDesignerWidgetMultiTabMemberListControllerBase.prototype._onBackgroundDroppableAccept =
    function (event, dragInfo) {
  ...
  /**********************************************************/
  DiagramDesignerWidgetMultiTabMemberListControllerBase.prototype._onBackgroundDrop =
      ...
      if (params &&
        ...
        for (i in params.positions) {
          if (params.positions.hasOwnProperty(i)) {
            ...
            _client.setMemberRegistry(memberListContainerID, i,
              memberListToAddTo, MEMBER_POSITION_REGISTRY_KEY, {
                'x': posX,
                'y': posY
              });
            ...
            this._widget.updateDesignerItem(componentID, {
              "position": {
                'x': posX,
                'y': posY
              }
        ...
        if (gmeIDList.length > 0) {
          for (i = 0; i < gmeIDList.length; i += 1) {
            ...
            if (this._memberListMembers[memberListToAddTo].indexOf(
              componentID) === -1) {
              ...
              _client.addMember(memberListContainerID, componentID,
                memberListToAddTo);
              _client.setMemberRegistry(memberListContainerID, componentID,
                memberListToAddTo, MEMBER_POSITION_REGISTRY_KEY, {
                  'x': posX,
                  'y': posY
                });
  ...
  /*************************************************************/
  DiagramDesignerWidgetMultiTabMemberListControllerBase.prototype._onSelectionDelete =
    function (idList) {
      var _client = this._client,
        memberListContainerID = this._memberListContainerID,
      ...
      while (len--) {
        ...
        _client.removeMember(memberListContainerID, gmeID,
          memberListToRemoveFrom);
      }
  ...
  DiagramDesignerWidgetMultiTabMemberListControllerBase.prototype._initializeSelectedMemberList =
    function () {
      var len,
        self = this,
        client = this._client;
      ...
      if (this._selectedMemberListID && this._memberListMembers[this._selectedMemberListID]) {
        ...
        while (len--) {
          this._selectedMemberListMembers.push(this._memberListMembers[this._selectedMemberListID]
            [len]);
          this._selectedMemberListMembersTerritoryPatterns[this._memberListMembers[
            this._selectedMemberListID][len]] = {
            "children": 0
          };
        }
      }

      this._selectedMemberListMembersTerritoryId = this._client.addUI(this,
        function (events) {
  ...
  DiagramDesignerWidgetMultiTabMemberListControllerBase.prototype._memberListTerritoryCallback =
    function (events) {
      ...
      while (len--) {
        if ((events[len].etype === CONSTANTS.TERRITORY_EVENT_LOAD) || (events[
          len].etype === CONSTANTS.TERRITORY_EVENT_UPDATE)) {

          obj = client.getNode(events[len].eid);

          events[len].desc = {
            isConnection: GMEConcepts.isConnection(events[len].eid)
          };
      ...
      client.decoratorManager.download(decoratorsToDownload, WIDGET_NAME,
        function () {
          self._dispatchEvents(events);
        });
  };

  DiagramDesignerWidgetMultiTabMemberListControllerBase.prototype._dispatchEvents =
    function (events) {
      var i,
        e,
        territoryChanged = false,
      ...
      this.logger.debug("_dispatchEvents '" + events.length + "' items: " +
      ...
      if (this._delayedConnections && this._delayedConnections.length > 0) {
          ...
          if (e.etype === CONSTANTS.TERRITORY_EVENT_UNLOAD) {
            ...
            while (j--) {
              if (this._delayedConnections[j].ID === e.eid) {
                this.logger.debug('Removing ' + e.eid +
                  ' from delayed connections...');
                ...
                delete this._delayedConnectionsAsItems[this._delayedConnections[
                  j].ID];
              }
            }
            ...
            while (j--) {
              if (this._delayedConnections[j].ID === e.eid) {
                this.logger.debug('Updating ' + e.eid +
                  ' in delayed connections...');
        ...
        for (i = 0; i < this._delayedConnections.length; i += 1) {
          ...
          //TODO: connection as box
          //remove the box that represents this connections
          this._widget.deleteComponent(this._delayedConnectionsAsItems[this._delayedConnections[
            i].ID]);
      ...
      this.logger.debug("_dispatchEvents '" + events.length +
        "' items - DONE");
  };

  DiagramDesignerWidgetMultiTabMemberListControllerBase.prototype._updateDecoratorTerritoryQuery =
    function (decorator, doDelete) {
      var query,
        entry,
        territoryPatterns = this._selectedMemberListMembersTerritoryPatterns,
        territoryChanged = false;
  ...
  DiagramDesignerWidgetMultiTabMemberListControllerBase.prototype._getItemDecorator =
    function (decorator) {
      var result;

      result = this._client.decoratorManager.getDecoratorForWidget(decorator,
        WIDGET_NAME);

      if (!result) {
        result = this._client.decoratorManager.getDecoratorForWidget(
          DEFAULT_DECORATOR, WIDGET_NAME);
      }

      return result;
  };

  DiagramDesignerWidgetMultiTabMemberListControllerBase.prototype._getAllSourceDestinationPairsForConnection =
    function (GMESrcId, GMEDstId) {
      var sources = [],
        destinations = [],
        i;
      ...
      if (this._GMEID2ComponentID.hasOwnProperty(GMESrcId)) {
        ...
        if (this._GMEID2Subcomponent && this._GMEID2Subcomponent.hasOwnProperty(
          GMESrcId)) {
  ...
  DiagramDesignerWidgetMultiTabMemberListControllerBase.prototype._onLoad =
    function (gmeID, desc) {
      var uiComponent,
        decClass,
        objDesc = {},
      ...
      if (this._selectedMemberListMembers.indexOf(gmeID) !== -1) {
        ...
        if (desc.isConnection === false) {
          ...
          if (this._memberListMemberCoordinates[this._selectedMemberListID] &&
            this._memberListMemberCoordinates[this._selectedMemberListID][
              gmeID
            ]) {
            objDesc.position.x = this._memberListMemberCoordinates[this._selectedMemberListID]
            [gmeID].x;
            objDesc.position.y = this._memberListMemberCoordinates[this._selectedMemberListID]
            [gmeID].y;
          }
          ...
          territoryChanged = territoryChanged || this._updateDecoratorTerritoryQuery(
            uiComponent._decoratorInstance, false);
        } else {

          var srcDst = this._getAllSourceDestinationPairsForConnection(desc.srcID,
            desc.dstID);
          ...
          var connVisualProperties = this._getConnectionVisualProperties(
            gmeID);
          ...
          if (k > 0 && l > 0) {
            while (k--) {
              while (l--) {
                ...
                this.logger.debug('Connection: ' + uiComponent.id +
                  ' for GME object: ' + gmeID);

                this._GMEID2ComponentID[gmeID] = this._GMEID2ComponentID[
                  gmeID] || [];
                this._GMEID2ComponentID[gmeID].push(uiComponent.id);
                this._ComponentID2GMEID[uiComponent.id] = gmeID;
              }
  ...
  DiagramDesignerWidgetMultiTabMemberListControllerBase.prototype._onUpdate =
    function (gmeID, desc) {
      var componentID,
        len,
        objDesc = {};
  ...
  DiagramDesignerWidgetMultiTabMemberListControllerBase.prototype._onUnload =
    function (gmeID) {
      var componentID,
        len,
        territoryChanged = false,
      ...
      if (this._GMEID2ComponentID.hasOwnProperty(gmeID)) {
        ...
        while (len--) {
          ...
          inOutConnections = this._widget._getAssociatedConnectionsForItems([
            componentID
          ]);
          ...
          if (inOutConnections && inOutConnections.length > 0) {
            ...
            while (cLen--) {
              ...
              var idx = this._GMEID2ComponentID[connGMEID].indexOf(
                componentID);
              if (idx > -1) {
  ...
  DiagramDesignerWidgetMultiTabMemberListControllerBase.prototype.registerComponentIDForPartID =
    function (componentID, partId) {
      this._componentIDPartIDMap[componentID] = this._componentIDPartIDMap[
        componentID] || [];
  ...
  DiagramDesignerWidgetMultiTabMemberListControllerBase.prototype.unregisterComponentIDFromPartID =
    function (componentID, partId) {
      var idx;

      if (this._componentIDPartIDMap && this._componentIDPartIDMap[
        componentID]) {
  ...
  DiagramDesignerWidgetMultiTabMemberListControllerBase.prototype._checkComponentDependency =
    function (gmeID, eventType) {
      var len;
      if (this._componentIDPartIDMap && this._componentIDPartIDMap[gmeID]) {
        len = this._componentIDPartIDMap[gmeID].length;
        while (len--) {
          this._notifyPackage[this._componentIDPartIDMap[gmeID][len]] = this._notifyPackage[
            this._componentIDPartIDMap[gmeID][len]] || [];
  ...
  DiagramDesignerWidgetMultiTabMemberListControllerBase.prototype._handleDecoratorNotification =
    function () {
      var gmeID,
        i,
        itemID;
      ...
      for (gmeID in this._notifyPackage) {
        if (this._notifyPackage.hasOwnProperty(gmeID)) {
          this.logger.debug('NotifyPartDecorator: ' + gmeID +
            ', componentIDs: ' + JSON.stringify(this._notifyPackage[gmeID]));
          ...
          if (this._GMEID2ComponentID.hasOwnProperty(gmeID)) {
            ...
            while (i--) {
              ...
              this._widget.notifyItemComponentEvents(itemID, this._notifyPackage[
                gmeID]);
            }
          }
        }
  ...
  /*
     ...
     */
  DiagramDesignerWidgetMultiTabMemberListControllerBase.prototype._onTabTitleChanged =
    function (tabID, oldValue, newValue) {
      ...
      if (memberListContainerID &&
        ...
        memberListSetsRegistry = memberListContainer.getEditableRegistry(
          memberListSetsRegistryKey) || [];
        ...
        if (this._tabIDMemberListID[tabID]) {
          ...
          this._client.setRegistry(memberListContainerID,
            memberListSetsRegistryKey, memberListSetsRegistry);
        }
      }
  };
  ...
  /*
     ...
     */
  DiagramDesignerWidgetMultiTabMemberListControllerBase.prototype._onTabsSorted =
    function (newTabIDOrder) {
      var memberListContainerID = this._memberListContainerID,
        memberListContainer,
        memberListSetsRegistryKey = this.getMemberListSetsRegistryKey(),
        memberListSetsRegistry,
  ...
  DiagramDesignerWidgetMultiTabMemberListControllerBase.prototype._onTabDeleteClicked =
    function (tabID) {
      var memberListContainerID = this._memberListContainerID,
        memberListContainer,
        memberListSetsRegistryKey = this.getMemberListSetsRegistryKey(),
  ...
  DiagramDesignerWidgetMultiTabMemberListControllerBase.prototype._onTabAddClicked =
    function () {
      var memberListContainerID = this._memberListContainerID,
        memberListContainer,
        memberListSetsRegistryKey = this.getMemberListSetsRegistryKey(),
  ...
  DiagramDesignerWidgetMultiTabMemberListControllerBase.prototype._canAddTab =
    function () {
      var memberListContainerID = this._memberListContainerID;
  ...
  DiagramDesignerWidgetMultiTabMemberListControllerBase.prototype.getNewSetNamePrefixDesc =
    function () {
      var result = {
        'SetID': 'SET_',
        'Title': 'Tab '
      ...
      this.logger.warning(
        'DiagramDesignerWidgetMultiTabMemberListControllerBase.getNewSetNamePrefixDesc is not overridden, returning default value: ' +
        JSON.stringify(result));
      return result;
  };

  DiagramDesignerWidgetMultiTabMemberListControllerBase.prototype._onSelectionChanged =
  ...
  DiagramDesignerWidgetMultiTabMemberListControllerBase.prototype.displayNoTabMessage =
    function () {
      this._widget.setBackgroundText('NO TAB TO DISPLAY...');
  };

  DiagramDesignerWidgetMultiTabMemberListControllerBase.prototype._displayContainerObjectName =
    function () {
      var memberListContainerObj = this._client.getNode(this._memberListContainerID);

      if (memberListContainerObj) {
        this._widget.setTitle(memberListContainerObj.getAttribute(
          nodePropertyNames.Attributes.name));
      }
  };

  DiagramDesignerWidgetMultiTabMemberListControllerBase.prototype._onSelectionSetColor =
    function (selectedIds, color, regKey) {
      ...
      while (i--) {
        ...
        if (color) {
          this._client.setMemberRegistry(containerID, gmeID, setID, regKey,
            color);
        } else {
  ...
  DiagramDesignerWidgetMultiTabMemberListControllerBase.prototype._getConnectionVisualProperties =
    function (objID) {
      var connVisualProperties = GMEVisualConcepts.getConnectionVisualProperties(
          objID),
      ...
      val = memberListContainer.getMemberRegistry(this._selectedMemberListID,
        objID, REGISTRY_KEYS.LINE_CUSTOM_POINTS);
      if (val && _.isArray(val)) {
        connVisualProperties[CONSTANTS.LINE_STYLE.CUSTOM_POINTS] = $.extend(
          true, [], val);
      }
  ...
  DiagramDesignerWidgetMultiTabMemberListControllerBase.prototype._onConnectionSegmentPointsChange =
    function (params) {
  ...
  DiagramDesignerWidgetMultiTabMemberListControllerBase.prototype._onRegisterSubcomponent =
    function (objID, sCompID, metaInfo) {
      //store that a subcomponent with a given ID has been added to object with objID
      this._GMEID2Subcomponent[metaInfo[CONSTANTS.GME_ID]] = this._GMEID2Subcomponent[
        metaInfo[CONSTANTS.GME_ID]] || {};
  ...
  DiagramDesignerWidgetMultiTabMemberListControllerBase.prototype._onUnregisterSubcomponent =
    function (objID, sCompID) {
  ...
  DiagramDesignerWidgetMultiTabMemberListControllerBase.prototype._displayConnectionAsItem =
    function (gmeID, desc) {
      var uiComponent,
        decClass,
        objDesc = {};
