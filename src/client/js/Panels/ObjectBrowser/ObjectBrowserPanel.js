...
define(['js/PanelBase/PanelBaseWithHeader',
  ...
  ObjectBrowserPanel.prototype._initialize = function () {
    ...
    compositionTreeBrowserWidget = new TreeBrowserWidget(this.$el.find(
      'div#composition').first());
    compositionTreeBrowserControl = new TreeBrowserControl(this._client,
      compositionTreeBrowserWidget);

    inheritanceTreeBrowserWidget = new TreeBrowserWidget(this.$el.find(
      'div#inheritance').first());
    inheritanceTreeBrowserControl = new InheritanceBrowserControl(this._client,
      inheritanceTreeBrowserWidget);

    crosscutTreeBrowserWidget = new TreeBrowserWidget(this.$el.find(
      'div#crosscut').first());
    crosscutTreeBrowserControl = new CrosscutBrowserControl(this._client,
      crosscutTreeBrowserWidget);
  };
