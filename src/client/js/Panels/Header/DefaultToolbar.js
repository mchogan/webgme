...
define(['clientUtil',
  ...
  DefaultToolbar.prototype._initialize = function () {
    ...
    toolbar.addButton({
      "title": "Display META entries...",
      "icon": "glyphicon glyphicon-barcode",
      "clickFn": function ( /*data*/ ) {
        alert('METAAspectTypes: \n' + JSON.stringify(METAAspectHelper.getMETAAspectTypesSorted(),
          undefined, 2));
      }
    });

    toolbar.addButton({
      "title": "Download Domain's META javascript...",
      ...
      "clickFn": function ( /*data*/ ) {
        ...
        if (meta && !_.isEmpty(meta)) {
          ...
          pom.setAttribute('href', 'data:text/plain;charset=utf-8,' +
            encodeURIComponent(meta.content));
          ...
          alert(
            'Something went wrong, METAAspectTypes are not available...');
        }
      }
    });
  ...
  DefaultToolbar.prototype._createDummyControls = function () {
    ...
    //DEMO controls
    var btnCommit1 = toolbar.addButton({
      "title": "Commit1...",
    ...
    var btnToggle1 = toolbar.addToggleButton({
      "title": "Toggle button",
    ...
    var chb = toolbar.addCheckBox({
      "title": "BLA",
      "checkChangedFn": function (data, checked) {
        console.log('checked: ' + checked + ', data: ' + JSON.stringify(
          data));
      }
    });

    var ddlCreate = toolbar.addDropDownButton({
      "text": "Create..."
    });
    ddlCreate.addButton({
      "title": "Create 1 item",
