...
define(['logManager',
  ...
  GridPanelContainmentControPointers.prototype.selectedObjectChanged =
    function (nodeId) {
      var self = this;
  ...
  GridPanelContainmentControPointers.prototype._eventCallback = function (
    events) {
  ...
  GridPanelContainmentControPointers.prototype._discoverNode = function (
    gmeID) {
    var nodeDescriptor = {
        "ID": undefined,
        "Name": undefined,
  ...
  GridPanelContainmentControPointers.prototype._stateActiveObjectChanged =
    function (model, activeObjectId) {
      this.selectedObjectChanged(activeObjectId);
  };

  GridPanelContainmentControPointers.prototype.attachClientEventListeners =
    function () {
      this.detachClientEventListeners();
  ...
  GridPanelContainmentControPointers.prototype.detachClientEventListeners =
    function () {
      WebGMEGlobal.State.off('change:' + CONSTANTS.STATE_ACTIVE_OBJECT, this._stateActiveObjectChanged);
  };

  //attach GridPanelContainmentControPointers - DataGridViewEventHandlers event handler functions
  _.extend(GridPanelContainmentControPointers.prototype,
