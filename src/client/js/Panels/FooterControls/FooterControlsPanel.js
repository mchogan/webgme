...
define([
  ...
  function (
    ...
    FooterControlsPanel.prototype._initialize = function () {
      ...
      pullLeft.append($(
        '<div class="navbar-text"><div class="webgme-copyright">© 2014 <a href="http://www.isis.vanderbilt.edu/" title="Vanderbilt University" target="_blank">Vanderbilt University</a></div></div>'
      ));
      navBarInner.append(pullLeft);

      //add version UI piece
      pullLeft = $('<div class="pull-left inline"></div>');
      pullLeft.append($('<div class="navbar-text"><div class="webgme-version">version: ' + WebGMEGlobal.version +
        '</div></div>'));
      navBarInner.append(pullLeft);
