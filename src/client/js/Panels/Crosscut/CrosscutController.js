...
define(['logManager',
  ...
  CrosscutController.prototype._attachDiagramDesignerWidgetEventHandlers = function () {
    ...
    DiagramDesignerWidgetMultiTabMemberListControllerBase.prototype._attachDiagramDesignerWidgetEventHandlers.call(
      this);
  ...
  CrosscutController.prototype._onUnload = function (gmeID) {
    ...
    while (len--) {
      ...
      this._saveConnectionToWaitingList(this._connectionListByID[connectionID].GMESrcId, this._connectionListByID[
          connectionID].GMEDstId, this._connectionListByID[connectionID].type, this._connectionListByID[connectionID]
        .connTexts);
      this._removeConnection(this._connectionListByID[connectionID].GMESrcId, this._connectionListByID[connectionID].GMEDstId,
    ...
    while (len--) {
      ...
      if (gmeID) {
        ...
        if (lineDesc) {
          ...
          //  #2/a: do not let the user delete an src/dst pointer??
          if (lineDesc.type === MetaRelations.META_RELATIONS.POINTER && NON_DELETABLE_POINTERS.indexOf(lineDesc.name) !==
            -1) {
