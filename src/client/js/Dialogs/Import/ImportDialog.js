...
define(['loaderCircles',
  ...
  ImportDialog.prototype._fileSelectHandler = function (event) {
    ...
    if (file && file.length > 0) {
      ...
      if (file.size > MAX_FILE_SIZE) {
        self._displayMessage(file.name + ':<br><br>FILE SITE IS TOO BIG...',
          true);
      } else {
        ...
        reader.onload = function (e) {
          ...
          if (parsedJSONFileContent === undefined) {
            ...
            self._displayMessage(
              'File has been parsed successfully, click \'Import...\' to start importing.',
              false);
  ...
  ImportDialog.prototype._displayMessage = function (msg, isError) {
    this._importErrorLabel.removeClass('alert-success').removeClass(
      'alert-danger');
