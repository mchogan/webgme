...
define(['underscore',
  ...
  Preferences.prototype.getRegistry = function (objID, regKey,
    includeItemRegistry) {
    var i,
    ...
    for (i = 0; i < len; i += 1) {
      ...
      if (container) {
        result = container.getMemberRegistry(registryDesc.setID, objID,
          regKey);
  ...
  Preferences.prototype.setRegistry = function (objID, regKey, value) {
    ...
    if (this._registryList.length === 0) {
      ...
      _client.setMemberRegistry(registryDesc.containerID, objID, registryDesc
        .setID, regKey, value);
    }
  };
  ...
  Preferences.prototype.delRegistry = function (objID, regKey) {
    ...
    if (this._registryList.length === 0) {
      ...
      registryDesc = this._registryList[0];
      _client.delMemberRegistry(registryDesc.containerID, objID, registryDesc
        .setID, regKey);
    }
  };
