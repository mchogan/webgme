...
define(['jquery',
  ...
  var _createBasicProjectSeed = function () {
    ...
    _client.setMemberRegistry(CONSTANTS.PROJECT_ROOT_ID, FCO_ID, MetaEditorConstants.META_ASPECT_SET_NAME,
    ...
    _client.setMemberRegistry(CONSTANTS.PROJECT_ROOT_ID, FCO_ID, defaultMetaSheetID, REGISTRY_KEYS.POSITION, {
      'x': 100,
      'y': 100
    });
  ...
  var _getValidPointerTargetTypesFromSource = function (objID, isSet) {
    var result = [],
      ...
      pointerNames = isSet ? _.difference(nodeObj.getSetNames(), EXCLUDED_SETS) : _.difference(nodeObj.getPointerNames(),
        EXCLUDED_POINTERS),
