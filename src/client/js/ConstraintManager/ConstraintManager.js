        ...
        constraints.forEach(function (constraint) {
          ...
          try {
            ...
            if (result === true) {
              ...
              addValidationResult('FAIL' + msg + '<br/><span class="muted">' + constraint.message + '</span>',
                'alert-error');
            }
          } catch (exp) {
            addValidationResult('ERROR' + msg + '<br/><span class="muted">Constraint threw an exception:<br/>' +
