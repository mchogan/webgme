...
define(['logManager',
    ...
    require([LAYOUT_PATH + layout],
      function (Layout) {
        if (Layout) {
          ...
          self._logger.error("Layout '" + layout +
            "' has been downloaded...BUT UNDEFINED!!!");
        }
      },
      function (err) {
        //on error
        self._logger.error("Failed to load layout because of '" + err.requireType +
  ...
  LayoutManager.prototype.loadPanel = function (params, fnCallback) {
    ...
    this._logger.debug('LayoutManager loadPanel with name: "' + name +
      '", container: "' + container + '"');
      ...
      require([rPath],
        function (Panel) {
          if (Panel) {
            ...
            self._logger.error("Panel '" + panel +
              "' has been downloaded...BUT UNDEFINED!!!");
          }
        ...
        function (err) {
          //on error
          self._logger.error("Failed to load Panel '" + rPath +
