...
define(['js/Constants',
  ...
  'css!./SVGDecorator.DiagramDesignerWidget.css'
], function (CONSTANTS,
  nodePropertyNames,
  ...
  /************************ INHERITANCE *********************/
  _.extend(SVGDecoratorDiagramDesignerWidget.prototype,
  ...
  /**** Override from DiagramDesignerWidgetDecoratorBase ****/
  SVGDecoratorDiagramDesignerWidget.prototype.$DOMBase = $(
    SVGDecoratorTemplate);
  ...
  /**** Override from DiagramDesignerWidgetDecoratorBase ****/
  SVGDecoratorDiagramDesignerWidget.prototype.onRenderGetLayoutInfo =
    function () {
      ...
      this.svgBorderWidth = parseInt(this.$svgContent.find('svg').css(
        'border-width'), 10);
  ...
  SVGDecoratorDiagramDesignerWidget.prototype.onRenderSetLayoutInfo =
    function () {
      var xShift = Math.ceil((this.svgContainerWidth - this.svgWidth) / 2 +
          this.svgBorderWidth),
      ...
      DiagramDesignerWidgetDecoratorBase.prototype.onRenderSetLayoutInfo.call(
        this);
  };

  /**** Override from DiagramDesignerWidgetDecoratorBase ****/
  SVGDecoratorDiagramDesignerWidget.prototype.getConnectionAreas = function (
    ...
    if (id === undefined || id === this.hostDesignerItem.id) {
      if (this._customConnectionAreas && this._customConnectionAreas.length >
        0) {
  ...
  SVGDecoratorDiagramDesignerWidget.prototype.showSourceConnectors = function (
    params) {
    var connectors,
      i;
  ...
  SVGDecoratorDiagramDesignerWidget.prototype.showEndConnectors = function (
    params) {
  ...
  SVGDecoratorDiagramDesignerWidget.prototype.__onNodeTitleChanged = function (
    oldValue, newValue) {
  ...
  SVGDecoratorDiagramDesignerWidget.prototype.updateSubcomponent = function (
    portId) {
  ...
  SVGDecoratorDiagramDesignerWidget.prototype.__registerAsSubcomponent =
    function (portId) {
  ...
  SVGDecoratorDiagramDesignerWidget.prototype.__unregisterAsSubcomponent =
    function (portId) {
      if (this.hostDesignerItem) {
  ...
  /**** Override from DiagramDesignerWidgetDecoratorBase ****/
  SVGDecoratorDiagramDesignerWidget.prototype.notifyComponentEvent = function (
    componentList) {
