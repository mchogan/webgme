...
define(['js/Constants',
  ...
  'css!./SVGDecorator.PartBrowserWidget.css'
], function (CONSTANTS,
  nodePropertyNames,
  ...
  /************************ INHERITANCE *********************/
  _.extend(SVGDecoratorPartBrowserWidget.prototype,
  ...
  /**** Override from PartBrowserWidgetDecoratorBase ****/
  SVGDecoratorPartBrowserWidget.prototype.notifyComponentEvent = function (
    componentList) {
