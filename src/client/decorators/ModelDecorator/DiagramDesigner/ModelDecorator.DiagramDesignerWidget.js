...
define(['js/Constants',
  ...
  /************************ INHERITANCE *********************/
  _.extend(ModelDecoratorDiagramDesignerWidget.prototype,
  ...
  /**** Override from DiagramDesignerWidgetDecoratorBase ****/
  ModelDecoratorDiagramDesignerWidget.prototype.$DOMBase = $(
    modelDecoratorTemplate);
  ...
  ModelDecoratorDiagramDesignerWidget.prototype.on_addTo = function () {
    ...
    this.$el.on("dblclick.ptrDblClick", '.' + ModelDecoratorConstants.POINTER_CLASS,
      function (event) {
        if (!($(this).hasClass(ModelDecoratorConstants.POINTER_CLASS_NON_SET))) {
          self.__onPointerDblClick({
            'x': event.clientX,
            'y': event.clientY
          });
        }
  ...
  /**** Override from DiagramDesignerWidgetDecoratorBase ****/
  ModelDecoratorDiagramDesignerWidget.prototype.onRenderGetLayoutInfo =
    function () {
      this._paddingTop = parseInt(this.$el.css('padding-top'), 10);
      this._borderTop = parseInt(this.$el.css('border-top-width'), 10);

      DiagramDesignerWidgetDecoratorBase.prototype.onRenderGetLayoutInfo.call(
        this);
  };
  ...
  /**** Override from DiagramDesignerWidgetDecoratorBase ****/
  ModelDecoratorDiagramDesignerWidget.prototype.getConnectionAreas = function (
    ...
    if (id === undefined || id === this.hostDesignerItem.id) {
      ...
      result.push({
        "id": idx,
        "x1": portConnArea.x1,
        "y1": portConnArea.y1 + PORT_CONTAINER_OFFSET_Y + this._paddingTop +
          this._borderTop,
        "x2": portConnArea.x2,
        "y2": portConnArea.y2 + PORT_CONTAINER_OFFSET_Y + this._paddingTop +
          this._borderTop,
  ...
  ModelDecoratorDiagramDesignerWidget.prototype.updateSubcomponent = function (
    portId) {
  ...
  ModelDecoratorDiagramDesignerWidget.prototype.showSourceConnectors =
    function (params) {
      var connectors,
        i;
  ...
  ModelDecoratorDiagramDesignerWidget.prototype.hideSourceConnectors =
    function () {
      var i;
  ...
  ModelDecoratorDiagramDesignerWidget.prototype.showEndConnectors = function (
    params) {
  ...
  /**** Override from DiagramDesignerWidgetDecoratorBase ****/
  ModelDecoratorDiagramDesignerWidget.prototype.notifyComponentEvent =
  ...
  ModelDecoratorDiagramDesignerWidget.prototype._portPositionChanged =
    function (portId) {
      this.onRenderGetLayoutInfo();
      this.hostDesignerItem.canvas.dispatchEvent(this.hostDesignerItem.canvas
        .events.ITEM_SUBCOMPONENT_POSITION_CHANGED, {
  ...
  /**** Override from ModelDecoratorCore ****/
  ModelDecoratorDiagramDesignerWidget.prototype._setPointerTerritory =
    function (pointerTargets) {
      ...
      if (len > 0) {
        if (!this._territoryId) {
          this._territoryId = this._control._client.addUI(this, function (
            events) {
        ...
        while (len--) {
          this._selfPatterns[pointerTargets[len][1]] = {
            "children": 0
          };
        }
      }
  ...
  ModelDecoratorDiagramDesignerWidget.prototype.__onBackgroundDroppableOver =
    function (helper) {
  ...
  ModelDecoratorDiagramDesignerWidget.prototype.__onBackgroundDroppableOut =
    function () {
      this.__doAcceptDroppable(false);
  };

  ModelDecoratorDiagramDesignerWidget.prototype.__onBackgroundDrop = function (
    helper) {
    ...
    if (this.__acceptDroppable === true) {
      if (dragItems.length === 1 && dragEffects.indexOf(DragHelper.DRAG_EFFECTS
        .DRAG_CREATE_POINTER) !== -1) {
  ...
  ModelDecoratorDiagramDesignerWidget.prototype.__onBackgroundDroppableAccept =
    function (helper) {
      var dragInfo = helper.data(DragConstants.DRAG_INFO),
        dragItems = DragHelper.getDragItems(dragInfo),
        dragEffects = DragHelper.getDragEffects(dragInfo),
      ...
      if (dragItems.length === 1 &&
        ...
        dragEffects.indexOf(DragHelper.DRAG_EFFECTS.DRAG_CREATE_POINTER) !==
        -1) {
  ...
  ModelDecoratorDiagramDesignerWidget.prototype.__doAcceptDroppable =
    function (accept) {
      if (accept === true) {
  ...
  ModelDecoratorDiagramDesignerWidget.prototype.__onMouseEnter = function (
    event) {
  ...
  ModelDecoratorDiagramDesignerWidget.prototype.__onMouseLeave = function (
    event) {
  ...
  ModelDecoratorDiagramDesignerWidget.prototype.__registerAsSubcomponent =
    function (portId) {
      if (this.hostDesignerItem) {
        this.hostDesignerItem.registerSubcomponent(portId, {
          "GME_ID": portId
        });
      }
  };

  ModelDecoratorDiagramDesignerWidget.prototype.__unregisterAsSubcomponent =
    function (portId) {
      if (this.hostDesignerItem) {
  ...
  ModelDecoratorDiagramDesignerWidget.prototype.__onNodeTitleChanged =
    function (oldValue, newValue) {
      var client = this._control._client;

      client.setAttributes(this._metaInfo[CONSTANTS.GME_ID],
        nodePropertyNames.Attributes.name, newValue);
  };

  ModelDecoratorDiagramDesignerWidget.prototype.__onPointerDblClick =
    function (mousePos) {
  ...
  ModelDecoratorDiagramDesignerWidget.prototype._navigateToPointerTarget =
    function (targetID) {
      var client = this._control._client,
        targetNodeObj;
      ...
      if (targetNodeObj) {
        if (targetNodeObj.getParentId() || targetNodeObj.getParentId() ===
