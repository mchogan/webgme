...
define(['js/Constants',
  ...
  UMLStateMachineDecoratorCore.prototype.$DOMBase = $('<div/>', {
    'class': UMLStateMachineDecoratorClass
  });

  UMLStateMachineDecoratorCore.prototype._initializeDecorator = function (
    params) {
    this.$name = undefined;
  ...
  UMLStateMachineDecoratorCore.prototype._renderMetaTypeSpecificParts =
    function () {};
  ...
  /* TO BE OVERRIDDEN IN META TYPE SPECIFIC CODE */
  UMLStateMachineDecoratorCore.prototype._updateMetaTypeSpecificParts =
    function () {};
