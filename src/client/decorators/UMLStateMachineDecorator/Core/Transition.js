...
define(['raphaeljs',
  ...
  Transition.prototype._getTransitionLineStyle = function () {
    ...
    this._lineStyle[CONSTANTS.LINE_STYLE.PATTERN] = CONSTANTS.LINE_STYLE.PATTERNS
      .SOLID;
    this._lineStyle[CONSTANTS.LINE_STYLE.TYPE] = CONSTANTS.LINE_STYLE.TYPES.NONE;
    this._lineStyle[CONSTANTS.LINE_STYLE.START_ARROW] = CONSTANTS.LINE_STYLE.LINE_ARROWS
      .NONE;
    this._lineStyle[CONSTANTS.LINE_STYLE.END_ARROW] = CONSTANTS.LINE_STYLE.LINE_ARROWS
      .NONE;

    _.extend(this._lineStyle, GMEVisualConcepts.getConnectionVisualProperties(
      this._gmeID));
  };
  ...
  Transition.prototype._renderMetaTypeSpecificParts = function () {
    ...
    this.path = this.SVGPaper.path('M ' + MARGIN + ',' + Y + ' L ' + (WIDTH -
      MARGIN) + ',' + Y);
