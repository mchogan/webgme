...
define(['js/Constants',
  ...
  /************************ INHERITANCE *********************/
  _.extend(UMLStateMachineDecoratorDiagramDesignerWidget.prototype,
    DiagramDesignerWidgetDecoratorBase.prototype);
  _.extend(UMLStateMachineDecoratorDiagramDesignerWidget.prototype,
    UMLStateMachineDecoratorCore.prototype);

  /**************** OVERRIDE INHERITED / EXTEND ****************/

  /**** Override from DiagramDesignerWidgetDecoratorBase ****/
  UMLStateMachineDecoratorDiagramDesignerWidget.prototype.DECORATORID =
    DECORATOR_ID;
  ...
  /**** Override from DiagramDesignerWidgetDecoratorBase ****/
  UMLStateMachineDecoratorDiagramDesignerWidget.prototype.showSourceConnectors =
    function ( /*params*/ ) {
      this.$sourceConnectors.appendTo(this.$el.find('> div').first());
  };

  /**** Override from DiagramDesignerWidgetDecoratorBase ****/
  UMLStateMachineDecoratorDiagramDesignerWidget.prototype.showEndConnectors =
    function ( /*params*/ ) {
      this.$endConnectors.appendTo(this.$el.find('> div').first());
  };

  /**** Override from DiagramDesignerWidgetDecoratorBase ****/
  UMLStateMachineDecoratorDiagramDesignerWidget.prototype.onRenderGetLayoutInfo =
    function () {
      var META_TYPES = UMLStateMachineMETA.META_TYPES;

      //let the parent decorator class do its job first
      DiagramDesignerWidgetDecoratorBase.prototype.onRenderGetLayoutInfo.apply(
        this, arguments);

      if (this.$name) {
        if (META_TYPES.End &&
          META_TYPES.Initial &&
          (this._metaType === META_TYPES.End || this._metaType === META_TYPES
            .Initial)) {
  ...
  /**** Override from DiagramDesignerWidgetDecoratorBase ****/
  UMLStateMachineDecoratorDiagramDesignerWidget.prototype.onRenderSetLayoutInfo =
    function () {
      var META_TYPES = UMLStateMachineMETA.META_TYPES;
      ...
      if (this.renderLayoutInfo) {
        ...
        if (this.$name) {
          if (META_TYPES.End &&
            META_TYPES.Initial &&
            (this._metaType === META_TYPES.End || this._metaType ===
              META_TYPES.Initial)) {
            this.$name.css({
              "margin-left": shift
            });
      ...
      DiagramDesignerWidgetDecoratorBase.prototype.onRenderSetLayoutInfo.apply(
        this, arguments);
  };

  UMLStateMachineDecoratorDiagramDesignerWidget.prototype.getConnectionAreas =
  ...
  UMLStateMachineDecoratorDiagramDesignerWidget.prototype._onNodeTitleChanged =
