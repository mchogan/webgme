...
define(['clientUtil',
  ...
  ConstraintDetailsDialog.prototype.show = function (constraintDesc,
    constraintNames, saveCallBack, deleteCallBack) {
    var self = this;

    this._initDialog(constraintDesc, constraintNames, saveCallBack,
      deleteCallBack);
  ...
  ConstraintDetailsDialog.prototype._initDialog = function (constraintDesc,
    constraintNames, saveCallBack, deleteCallBack) {
    var self = this,
      closeSave,
      closeDelete,
