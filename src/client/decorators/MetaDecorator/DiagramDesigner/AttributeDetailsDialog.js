...
define(['clientUtil',
  ...
  AttributeDetailsDialog.prototype.show = function (attributeDesc,
    attributeNames, saveCallBack, deleteCallBack) {
    var self = this;

    this._initDialog(attributeDesc, attributeNames, saveCallBack,
      deleteCallBack);
  ...
  AttributeDetailsDialog.prototype._initDialog = function (attributeDesc,
    attributeNames, saveCallBack, deleteCallBack) {
    var self = this,
      closeSave,
      closeDelete,
    ...
    closeSave = function () {
      ...
      if (attrDesc.type === 'integer' ||
        attrDesc.type === 'float') {
        //number -> convert
        attrDesc.defaultValue = getTypeConvertedValue(attrDesc.defaultValue,
          attrDesc.type);
        ...
        attrDesc.defaultValue = self._el.find('#rbBooleanTrue').first().is(
          ':checked');
