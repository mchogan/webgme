...
define(['clientUtil',
  ...
  AspectDetailsDialog.prototype.show = function (aspectDesc, aspectNames,
    saveCallBack, deleteCallBack) {
    var self = this;
  ...
  AspectDetailsDialog.prototype._initDialog = function (aspectDesc,
    aspectNames, saveCallBack, deleteCallBack) {
    var self = this,
      closeSave,
      closeDelete,
      isValidAspectName,
    ...
    isValidAspectName = function (name) {
      return !(name === "" || aspectNames.indexOf(name) !== -1 || name.toLowerCase() ===
        CONSTANTS.ASPECT_ALL.toLowerCase());
    };
