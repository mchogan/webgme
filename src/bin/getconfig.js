...
if (typeof define !== "function" && typeof require === "function" && typeof process ===
  "object") {
  var FS = require("fs");
  ...
  FS.stat(name, function (err, stat) {
    if (err && err.errno === 34) {
      ...
      console.log(
        "Config.js already exists, please modify or delete it by hand");
    } else {
  ...
  define(["ifexists!bin/config"], function (LOCAL) {
    ...
    if (LOCAL) {
      ...
      LOCAL.visualizerDescriptors = GLOBAL.visualizerDescriptors.concat(LOCAL
        .visualizerDescriptors);
