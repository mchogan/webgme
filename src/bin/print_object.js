...
requirejs(["util/assert", "core/tasync", "util/common"], function (ASSERT,
  ...
  function main() {
    ...
    if (argv.length < 1 || COMMON.getParameters("help") !== null) {
      ...
      console.log("");
      console.log(
        "Prints out the storage objects starting from the selected object. The selector"
      );
      console.log(
        "is a string that starts with a hash fragment, optionally followed by a relid"
      );
